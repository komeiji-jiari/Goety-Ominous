...
extends Item {
    ...
    public ItemStack m_5922_(ItemStack itemstack, Level world, LivingEntity entity) {
        ...
        if (!world.f_46443_ && entity instanceof Player) {
            ...
            player.getCapability(LichProvider.CAPABILITY).ifPresent(lichdom -> {
                ...
                if (!modData.m_128471_(GOBLET_BATS_UNLOCKED)) {
                    modData.m_128379_(GOBLET_BATS_UNLOCKED, true);
    ...
    public void m_7373_(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add((Component)Component.m_237113_((String)"Allows the Lich who drinks this to gain the power to summon bats when damaged."));
