...
public class GobletofFlightItem
extends Item {
        ...
        if (!world.f_46443_ && entity instanceof Player) {
            ...
            player.getCapability(LichProvider.CAPABILITY).ifPresent(lichdom -> {
                ...
                if (!modData.m_128471_(GOBLET_FLIGHT_UNLOCKED)) {
                    modData.m_128379_(GOBLET_FLIGHT_UNLOCKED, true);
    ...
    public void m_7373_(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add((Component)Component.m_237113_((String)"Allows any Lich who drinks it to gain the ability to fly."));
