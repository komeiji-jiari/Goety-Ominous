...
public class PoisonBoltRenderer extends EntityRenderer<PoisonBolt> {
   ...
   public void render(PoisonBolt entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn,
      ...
      this.model.renderToBuffer(matrixStackIn, vertexconsumer, 15728640, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F,
            0.5F);
    ...
    */
   private void renderTrail(PoisonBolt entityIn, float partialTicks, PoseStack matrixStackIn,
         MultiBufferSource bufferIn, float red, float green, float blue, float alpha, int packedLightIn) {
      int samples = 0;
      int sampleSize = 1;
