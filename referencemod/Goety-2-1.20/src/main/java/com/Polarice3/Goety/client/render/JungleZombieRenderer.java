...
public class JungleZombieRenderer
      extends HumanoidMobRenderer<JungleZombieServant, PlayerZombieModel<JungleZombieServant>> {
   protected static final ResourceLocation TEXTURE = Goety
         .location("textures/entity/servants/zombie/jungle_zombie_servant.png");
   private static final ResourceLocation ZOMBIE_LOCATION = Goety
         .location("textures/entity/servants/zombie/jungle_zombie_original.png");
   ...
   public JungleZombieRenderer(EntityRendererProvider.Context entityRendererManager) {
      ...
      this.addLayer(new HumanoidArmorLayer<>(this,
            new HumanoidModel<>(entityRendererManager.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)),
            new HumanoidModel<>(entityRendererManager.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)),
            entityRendererManager.getModelManager()));
   }
