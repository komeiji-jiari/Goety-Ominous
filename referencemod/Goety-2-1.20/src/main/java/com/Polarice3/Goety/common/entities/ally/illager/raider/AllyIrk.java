...
public class AllyIrk extends Minion {
    ...
    public void setConfigurableAttributes() {
        ...
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE),
                AttributesConfig.SummonedIrkDamage.get());
    }
    ...
    class OutofBoundsGoal extends Goal {
        ...
        public void tick() {
            ...
            blockpos$mutable.setY(AllyIrk.this.level
                    .getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, blockpos$mutable).getY());
            AllyIrk.this.getMoveControl().setWantedPosition(blockpos$mutable.getX(), blockpos$mutable.getY(),
        ...
        public void tick() {
            ...
            if (livingentity != null) {
                if (AllyIrk.this.shootTime == 10) {
                    ...
                    smallFireballEntity.setPos(smallFireballEntity.getX(), AllyIrk.this.getY(0.5D),
                ...
                if (AllyIrk.this.shootTime == 0) {
                    ...
                    Vec3 vector3d1 = new Vec3(vector3d0.x - AllyIrk.this.getX(), 0.0D,
                            vector3d0.z - AllyIrk.this.getZ());
    ...
    class MoveRandomGoal extends Goal {
        ...
        public void tick() {
            ...
            for (int i = 0; i < 3; ++i) {
                BlockPos blockpos1 = blockpos.offset(AllyIrk.this.random.nextInt(8) - 4,
                        AllyIrk.this.random.nextInt(6) - 2, AllyIrk.this.random.nextInt(8) - 4);
                if (AllyIrk.this.level.isEmptyBlock(blockpos1)) {
                    AllyIrk.this.moveControl.setWantedPosition((double) blockpos1.getX() + 0.5D,
                            (double) blockpos1.getY() + 0.5D, (double) blockpos1.getZ() + 0.5D, 0.25D);
                    if (AllyIrk.this.getTarget() == null) {
                        AllyIrk.this.getLookControl().setLookAt((double) blockpos1.getX() + 0.5D,
