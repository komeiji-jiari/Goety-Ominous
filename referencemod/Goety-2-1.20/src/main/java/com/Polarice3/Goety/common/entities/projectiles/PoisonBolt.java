...
public class PoisonBolt extends SpellHurtingProjectile {
    private static final EntityDataAccessor<Integer> DATA_TYPE_ID = SynchedEntityData.defineId(PoisonBolt.class,
    ...
    protected void onHit(HitResult p_37628_) {
        ...
        if (!this.level.isClientSide) {
            ...
            for (int p = 0; p < 32; ++p) {
                ...
                serverLevel.sendParticles(ModParticleTypes.CULT_SPELL.get(), d0, d1, d2, 0, colors[0], colors[1],
                        colors[2], 1.0F);
            }
            this.discard();
        }
    ...
    /**
     * Ripped Trail effect from @AlexModGuy: <a href=
     * "https://github.com/AlexModGuy/AlexsCaves/blob/main/src/main/java/com/github/alexmodguy/alexscaves/server/entity/item/WaterBoltEntity.java">...</a>
     */
