...
public class GoetyRevelationCompat {
    ...
    public static Item getSoulOfObsidian() {
        ...
        try {
            ...
            System.err.println("[SomeIllagerServants] Failed to get Soul of Obsidian: " + e.getMessage());
            return null;
        }
    }
    ...
    public static boolean isHeresiarchServant(LivingEntity entity) {
        try {
            Class<?> heresiarchClass = Class.forName("com.qiuyue.someillagerservants.common.entities.ally.mobs.HeresiarchServant");
