...
import com.qiuyue.someillagerservants.client.render.model.FungusPackModel;
import com.qiuyue.someillagerservants.common.init.ModTags;
...
public class FungusPackItem extends ArmorItem implements ICurioItem {
    ...
    private static final ArmorMaterial MATERIAL = new ArmorMaterial() {
        @Override public String getName() { return SomeIllagerServants.MOD_ID + ":fungus_pack"; }
    ...
    public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, net.minecraft.nbt.CompoundTag nbt) {
        return new com.qiuyue.someillagerservants.common.items.capability.FungusPackItemCapability(stack);
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return SomeIllagerServants.MOD_ID + ":textures/models/armor/fungus_pack.png";
    }

    @Override
    public net.minecraft.nbt.CompoundTag getShareTag(net.minecraft.world.item.ItemStack stack) {
        net.minecraftforge.items.IItemHandler handler = com.qiuyue.someillagerservants.common.items.handler.FungusPackItemHandler.get(stack);
