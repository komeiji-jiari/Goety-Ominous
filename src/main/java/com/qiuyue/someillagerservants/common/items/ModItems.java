...
import com.qiuyue.someillagerservants.client.render.item.BoneCudgelRenderer;
...
import com.qiuyue.someillagerservants.common.items.curios.FungusPackItem;
import com.qiuyue.someillagerservants.common.items.curios.RaggedFungusPackItem;
import com.qiuyue.someillagerservants.common.items.curios.ScreamingSkullJar;
import com.qiuyue.someillagerservants.common.items.revive.BrokenStormCrown;
import com.qiuyue.someillagerservants.common.items.revive.StormSoulJar;
import com.qiuyue.someillagerservants.common.items.revive.SunkenSoulJar;
import com.qiuyue.someillagerservants.common.items.revive.ThunderHorn;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> BROOD_FOCUS = ITEMS.register("brood_focus",
            () -> new com.Polarice3.Goety.common.items.magic.MagicFocus(new com.qiuyue.someillagerservants.common.magic.spells.BroodSpell()));

    public static final RegistryObject<Item> SPIDER_FOCUS = ITEMS.register("spider_focus",
            () -> new com.Polarice3.Goety.common.items.magic.MagicFocus(new com.qiuyue.someillagerservants.common.magic.spells.SpiderSpell()));

    public static final RegistryObject<Item> REDSTONE_FOCUS = ITEMS.register("redstone_focus",
            () -> new com.Polarice3.Goety.common.items.magic.MagicFocus(new com.qiuyue.someillagerservants.common.magic.spells.RedstoneSpell()));

    public static final RegistryObject<Item> URBHADHACH_FOCUS = ITEMS.register("urbhadhach_focus",
            () -> new com.Polarice3.Goety.common.items.magic.MagicFocus(new com.qiuyue.someillagerservants.common.magic.spells.UrbhadhachSpell()));
    ...
    public static final RegistryObject<ForgeSpawnEggItem> THUG_SPAWN_EGG = ITEMS.register(
            "thug_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntityTypes.THUG, 0x5C4033, 0xD4A76A, egg()));
