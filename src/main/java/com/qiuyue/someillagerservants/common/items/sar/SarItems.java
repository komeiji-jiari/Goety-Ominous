package com.qiuyue.someillagerservants.common.items.sar;
...
import com.qiuyue.someillagerservants.common.magic.spells.sar.ConfusionBoltSpell;
import com.qiuyue.someillagerservants.common.magic.spells.sar.RunePrisonSpell;
import com.qiuyue.someillagerservants.common.magic.spells.sar.SporeCloudSpell;
...
public class SarItems {
    ...
    public static final DeferredRegister<Item> SAR_ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, SomeIllagerServants.MOD_ID);
