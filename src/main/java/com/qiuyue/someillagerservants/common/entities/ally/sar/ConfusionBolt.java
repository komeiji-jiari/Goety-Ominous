...
import com.qiuyue.someillagerservants.common.init.sar.SarEntityRegistry;
...
public class ConfusionBolt extends SpellThrowableProjectile {
    ...
    public ConfusionBolt(Level world, LivingEntity thrower, int ticksTillRemove) {
        super((EntityType<? extends SpellThrowableProjectile>) SarEntityRegistry.CONFUSION_BOLT.get(), thrower, world);
        this.setNoGravity(true);
    ...
    public ConfusionBolt(Level world, double x, double y, double z, int ticksTillRemove) {
        super((EntityType<? extends SpellThrowableProjectile>) SarEntityRegistry.CONFUSION_BOLT.get(), x, y, z, world);
        this.setNoGravity(true);
        this.entityData.set(TICKS_TILL_REMOVE, ticksTillRemove);
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        if (owner != null && entity instanceof LivingEntity living) {
            ...
            if (living instanceof com.Polarice3.Goety.common.entities.neutral.Owned ownedEntity) {
