...
import com.qiuyue.someillagerservants.common.entities.ai.PotionGroupGoal;
...
public class Fanatic extends AbstractSISCultist implements RangedAttackMob, ICultist {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(0, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_11.png"));
        map.put(1, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_1.png"));
        map.put(2, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_2.png"));
        map.put(3, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_3.png"));
        map.put(4, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_4.png"));
        map.put(5, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_5.png"));
        map.put(6, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_6.png"));
        map.put(7, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_7.png"));
        map.put(8, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_8.png"));
        map.put(9, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_9.png"));
        map.put(10, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/fanatic/fanatic_10.png"));
    });
