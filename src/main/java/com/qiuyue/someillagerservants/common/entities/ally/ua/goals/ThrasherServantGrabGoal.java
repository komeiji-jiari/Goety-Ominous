...
public class ThrasherServantGrabGoal extends MeleeAttackGoal {
    private final ThrasherServant thrasher;

    public ThrasherServantGrabGoal(ThrasherServant thrasher, double speedIn, boolean useLongMemory) {
    ...
    public boolean canUse() {
        ...
        if (attackTarget != null && attackTarget.isPassenger()) {
            if (attackTarget.getVehicle() instanceof ThrasherServant) {
                return false;
            }
        }
