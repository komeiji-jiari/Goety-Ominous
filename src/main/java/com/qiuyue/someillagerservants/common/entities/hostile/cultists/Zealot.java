...
public class Zealot extends AbstractSISCultist implements CrossbowAttackMob, RangedAttackMob, ICultist {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(0, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/zealot_1.png"));
        map.put(1, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/zealot_2.png"));
        map.put(2, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/zealot_3.png"));
        map.put(3, new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/zealot_4.png"));
    });
