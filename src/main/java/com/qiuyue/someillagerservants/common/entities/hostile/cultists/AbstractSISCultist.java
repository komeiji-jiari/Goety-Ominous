...
public abstract class AbstractSISCultist extends Cultist {

    private static final EntityDataAccessor<Float> DATA_REINFORCEMENT_CHANCE =
            SynchedEntityData.defineId(AbstractSISCultist.class, EntityDataSerializers.FLOAT);

    protected AbstractSISCultist(EntityType<? extends AbstractSISCultist> type, Level worldIn) {
        super(type, worldIn);
        this.xpReward = 10;
    }
        ...
        if (this.level() instanceof ServerLevel serverLevel) {
            if (this instanceof ICultist) {
                ...
                if (livingentity != null
                    ...
                    AbstractSISCultist cultist = null;
    ...
    public void conversion() {
        if (MobsConfig.CultistSpread.get()) {
            ...
            if (this.tickCount % timer == 0) {
                SISCultistHelper.secretConversion(this);
            }
        }
    }
    ...
    public boolean isAlliedTo(Entity entityIn) {
        ...
        } else if (entityIn instanceof AbstractSISCultist) {
            return this.getTeam() == null && entityIn.getTeam() == null;
