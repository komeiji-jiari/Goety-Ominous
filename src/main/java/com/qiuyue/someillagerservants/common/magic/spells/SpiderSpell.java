...
public class SpiderSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.someillagerservants.config.SpellConfig.SpiderCost.get();
    }

    public int defaultCastDuration() {
        return com.qiuyue.someillagerservants.config.SpellConfig.SpiderDuration.get();
    }
    ...
    public int defaultSpellCooldown() {
        return com.qiuyue.someillagerservants.config.SpellConfig.SpiderCoolDown.get();
    }

    public int SummonDownDuration() {
        return com.qiuyue.someillagerservants.config.SpellConfig.SpiderSummonDown.get();
    }
