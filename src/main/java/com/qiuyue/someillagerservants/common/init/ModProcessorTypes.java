...
import com.qiuyue.someillagerservants.common.worldgen.LootInjectorProcessor;
...
public class ModProcessorTypes {
    public static final DeferredRegister<StructureProcessorType<?>> PROCESSOR_TYPES =
            DeferredRegister.create(Registries.STRUCTURE_PROCESSOR, SomeIllagerServants.MOD_ID);
