...
public class LmSounds {
    ...
    public static final DeferredRegister<SoundEvent> LM_SOUNDS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, SomeIllagerServants.MOD_ID);

    public static final RegistryObject<SoundEvent> LM_MUSIC_DISC = LM_SOUNDS.register(
            "lm_music_disc",
            () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(SomeIllagerServants.MOD_ID, "lm_music_disc")));
