...
import com.qiuyue.someillagerservants.client.render.model.animation.AcolyteAnimations;
...
@OnlyIn(Dist.CLIENT)
public class AcolyteServantModel<T extends AcolyteServant> extends HierarchicalModel<T> {
    ...
    public AcolyteServantModel(ModelPart root) {
        this.root = root;
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(AcolyteAnimations.WALK, limbSwing, limbSwingAmount, 2.0F, 20.0F);
        this.animate(entity.idleAnimationState, AcolyteAnimations.IDLE, ageInTicks);
        this.animate(entity.attackAnimationState, AcolyteAnimations.ATTACK, ageInTicks);
        this.animate(entity.summonAnimationState, AcolyteAnimations.SUMMON, ageInTicks);
