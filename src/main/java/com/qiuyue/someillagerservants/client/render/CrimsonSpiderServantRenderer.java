...
import com.qiuyue.someillagerservants.client.render.layer.CrimsonSpiderEyesLayer;
...
public class CrimsonSpiderServantRenderer extends MobRenderer<CrimsonSpiderServant, SpiderModel<CrimsonSpiderServant>> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/cultist/crimson_spider.png");
