...
import com.qiuyue.someillagerservants.client.render.model.PiglinServantModel;
...
public class PiglinServantRenderer extends HumanoidMobRenderer<Mob, PiglinServantModel<Mob>> {
    ...
    static {
        TEXTURES = ImmutableMap.<EntityType<?>, ResourceLocation>builder()
                .put(com.qiuyue.someillagerservants.common.init.ModEntityTypes.PIGLIN_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/piglin_servant.png"))
                .put(com.qiuyue.someillagerservants.common.init.ModEntityTypes.PIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/piglin_brute_servant.png"))
                .put(com.qiuyue.someillagerservants.common.init.ModEntityTypes.STRONG_PIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/piglin_brute_servant_strong.png"))
                .put(com.qiuyue.someillagerservants.common.init.ModEntityTypes.ELITE_PIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/piglin_brute_servant_elite.png"))
                .put(com.qiuyue.someillagerservants.common.init.ModEntityTypes.PIGLIN_HUNTER_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/piglin_brute_servant.png"))
                .put(com.qiuyue.someillagerservants.common.init.ModEntityTypes.STRONG_PIGLIN_HUNTER_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/piglin_brute_servant_strong.png"))
                .put(com.qiuyue.someillagerservants.common.init.ModEntityTypes.ELITE_PIGLIN_HUNTER_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/piglin_brute_servant_elite.png"))
                .put(com.qiuyue.someillagerservants.common.init.ModEntityTypes.FUNGUS_THROWER.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/fungus_thrower.png"))
                .build();
    }
}
