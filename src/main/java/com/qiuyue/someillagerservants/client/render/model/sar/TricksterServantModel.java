...
import com.qiuyue.someillagerservants.common.entities.ally.sar.TricksterServant;
...
public class TricksterServantModel extends HumanoidModel<TricksterServant> {
    ...
    public TricksterServantModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(TricksterServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        super.setupAnim(entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
        AbstractIllagerServant.IllagerServantArmPose pose = entityIn.getArmPose();
        if (pose == AbstractIllagerServant.IllagerServantArmPose.SPELLCASTING || pose == AbstractIllagerServant.IllagerServantArmPose.CELEBRATING) {
