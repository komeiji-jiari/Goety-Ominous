...
public class GrieferServantArmorModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public GrieferServantArmorModel(int entityFlag) {
        this(entityFlag, createArmorLayer().bakeRoot());
    }

    public GrieferServantArmorModel(int entityFlag, ModelPart root) {
        super(root);
    ...
    public static HumanoidModel<?> getModel(EquipmentSlot slot, LivingEntity entity) {
        ...
        return CACHE.computeIfAbsent(entityFlag, GrieferServantArmorModel::new);
    }
}
