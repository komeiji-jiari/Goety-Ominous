...
import com.qiuyue.someillagerservants.client.render.model.ZPiglinHunterModel;
    ...
    static {
        TEXTURES = ImmutableMap.<EntityType<?>, ResourceLocation>builder()
                .put(ModEntityTypes.STRONG_ZPIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/zpiglin_brute_servant_strong.png"))
                .put(ModEntityTypes.ELITE_ZPIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/piglin/zpiglin_brute_servant_elite.png"))
