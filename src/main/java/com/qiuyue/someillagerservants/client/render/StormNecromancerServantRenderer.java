...
import com.qiuyue.someillagerservants.common.entities.ally.mobs.SunkenNecromancerServant;
...
@OnlyIn(Dist.CLIENT)
public class StormNecromancerServantRenderer extends MobRenderer<SunkenNecromancerServant, SunkenNecromancerModel<SunkenNecromancerServant>> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/storm_necromancer/storm_necromancer_servant.png");
    private static final ResourceLocation GLOW_TEXTURE = new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/storm_necromancer/storm_necromancer_glow.png");

    public StormNecromancerServantRenderer(EntityRendererProvider.Context context) {
