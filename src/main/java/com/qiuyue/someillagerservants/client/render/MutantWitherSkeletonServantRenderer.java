...
import com.qiuyue.someillagerservants.client.render.model.mm.MutantWitherSkeletonServantModel;
...
public class MutantWitherSkeletonServantRenderer extends MobRenderer<MutantWitherSkeletonServant, MutantWitherSkeletonServantModel<MutantWitherSkeletonServant>> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/mutant_wither_skeleton_servant.png");
    ...
    public MutantWitherSkeletonServantRenderer(EntityRendererProvider.Context context) {
        super(context, new MutantWitherSkeletonServantModel(context.bakeLayer(com.qiuyue.someillagerservants.client.render.model.mm.MutantWitherSkeletonServantModel.MAIN)), 1.25F);
        AdvancedArmourLayer.addCustomArmourLayers(this, context, com.qiuyue.someillagerservants.client.render.model.mm.MutantWitherSkeletonServantModel.INNER_ARMOUR, com.qiuyue.someillagerservants.client.render.model.mm.MutantWitherSkeletonServantModel.OUTER_ARMOUR);
