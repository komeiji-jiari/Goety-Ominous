package com.qiuyue.someillagerservants.client.render.layer.ua;

import com.mojang.blaze3d.vertex.PoseStack;
import com.qiuyue.someillagerservants.client.render.model.ua.ThrasherServantModel;
...
@OnlyIn(Dist.CLIENT)
public class ThrasherServantRenderLayer<T extends ThrasherServant, M extends ThrasherServantModel<T>> extends RenderLayer<T, M> {
    ...
    public ThrasherServantRenderLayer(RenderLayerParent<T, M> renderer) {
        super(renderer);
    }
    ...
    public ResourceLocation getThrasherFrostLayer(T thrasher) {
        return thrasher instanceof GreatThrasherServant ? GREAT_THRASHER_FROST : THRASHER_FROST;
    }
}
