...
import com.qiuyue.someillagerservants.client.render.layer.MagispellerServant.*;
...
public class MagispellerServantRenderer extends MobRenderer<MagispellerServant, MagispellerServantModel<MagispellerServant>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("someillagerservants", "textures/entity/illager/magispeller.png");
