...
import com.qiuyue.someillagerservants.client.render.layer.UrbhadhachVisageLayer;
...
public class UrbhadhachRenderer extends MobRenderer<UrbhadhachEntity, UrbhadhachModel<UrbhadhachEntity>> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(SomeIllagerServants.MOD_ID, "textures/entity/urbhadhach.png");
