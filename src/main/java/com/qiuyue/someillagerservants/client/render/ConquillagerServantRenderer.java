...
import com.qiuyue.someillagerservants.client.render.model.ConquillagerServantModel;
import com.qiuyue.someillagerservants.common.entities.ally.illager.ConquillagerServant;
...
public class ConquillagerServantRenderer<T extends ConquillagerServant>
    ...
    protected static final ResourceLocation TEXTURE = new ResourceLocation(SomeIllagerServants.MOD_ID,
