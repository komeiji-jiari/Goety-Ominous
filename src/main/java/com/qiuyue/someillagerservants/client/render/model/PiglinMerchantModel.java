...
import com.qiuyue.someillagerservants.client.render.model.animation.PiglinMerchantAnimations;
import com.qiuyue.someillagerservants.common.entities.ally.mobs.PiglinMerchant;
...
public class PiglinMerchantModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation("someillagerservants", "piglin_merchant"), "main");
