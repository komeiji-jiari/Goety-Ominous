package com.qiuyue.someillagerservants.client.render.model.sar;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.Iterables;
import com.Polarice3.Goety.common.entities.ally.illager.AbstractIllagerServant;
import com.qiuyue.someillagerservants.common.entities.ally.sar.GrieferServant;
...
@OnlyIn(Dist.CLIENT)
public class GrieferServantModel extends HumanoidModel<GrieferServant> {
    ...
    public GrieferServantModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(GrieferServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        AbstractIllagerServant.IllagerServantArmPose armPose = entityIn.getArmPose();
        if (armPose == AbstractIllagerServant.IllagerServantArmPose.CELEBRATING) {
    ...
    @Override
    public void prepareMobModel(GrieferServant entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
