...
import com.qiuyue.goetyominus.common.entities.hostile.cultists.AbstractGOCultist;
import com.qiuyue.goetyominus.common.entities.hostile.cultists.Beldam;
import com.qiuyue.goetyominus.config.MobsConfig;
import com.qiuyue.goetyominus.utils.GOCultistHelper;
            ...
            if (MobsConfig.CultistSpread.get()) {
                ...
                if (!witch.level().isClientSide && list.size() >= 5) {
                    ...
                    Beldam beldam = witch.convertTo(
                            com.qiuyue.goetyominus.common.init.ModEntityTypes.BELDAM.get(), true);
                    if (beldam != null) {
