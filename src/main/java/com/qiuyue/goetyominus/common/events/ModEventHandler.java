...
import com.qiuyue.goetyominus.common.entities.ally.mobs.HeresiarchServant;
...
public class ModEventHandler {
    ...
    public static void onLivingDrops(LivingDropsEvent event) {
        ...
        com.qiuyue.goetyominus.common.entities.ally.neutral.AbstractPiglinServant piglin = null;
        if (sourceEntity instanceof com.qiuyue.goetyominus.common.entities.ally.neutral.AbstractPiglinServant direct) {
            piglin = direct;
        } else if (sourceEntity instanceof com.Polarice3.Goety.api.entities.IOwned owned
                && owned.getTrueOwner() instanceof com.qiuyue.goetyominus.common.entities.ally.neutral.AbstractPiglinServant owner) {
            piglin = owner;
        }
