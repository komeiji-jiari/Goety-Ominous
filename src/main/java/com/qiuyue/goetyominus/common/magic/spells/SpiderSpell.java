...
public class SpiderSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.goetyominus.config.SpellConfig.SpiderCost.get();
    }

    public int defaultCastDuration() {
        return com.qiuyue.goetyominus.config.SpellConfig.SpiderDuration.get();
    }
    ...
    public int defaultSpellCooldown() {
        return com.qiuyue.goetyominus.config.SpellConfig.SpiderCoolDown.get();
    }

    public int SummonDownDuration() {
        return com.qiuyue.goetyominus.config.SpellConfig.SpiderSummonDown.get();
    }
