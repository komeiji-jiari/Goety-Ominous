...
import com.qiuyue.goetyominus.common.entities.ally.sar.SporeCloud;
...
public class SporeCloudSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.goetyominus.config.SpellConfig.SporeCloudSoulCost.get();
    }
    ...
    public int defaultSpellCooldown() {
        return com.qiuyue.goetyominus.config.SpellConfig.SporeCloudCooldown.get();
    }
