...
public class WitherSlashSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.goetyominus.config.SpellConfig.WitherSlashSoulCost.get();
    }

    @Override
    public int defaultSpellCooldown() {
        return com.qiuyue.goetyominus.config.SpellConfig.WitherSlashCooldown.get();
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        float baseDamage = com.qiuyue.goetyominus.config.SpellConfig.WitherSlashDamage.get().floatValue();
