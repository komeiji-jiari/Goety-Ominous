...
public class BroodSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.goetyominus.config.SpellConfig.BroodSoulCost.get();
    }
    ...
    public int SummonDownDuration() {
        return com.qiuyue.goetyominus.config.SpellConfig.BroodSummonDown.get();
    }
    ...
    public int defaultSpellCooldown() {
        return com.qiuyue.goetyominus.config.SpellConfig.BroodCoolDown.get();
    }
