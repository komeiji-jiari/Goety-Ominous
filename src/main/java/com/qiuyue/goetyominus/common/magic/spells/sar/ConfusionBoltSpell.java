...
import com.qiuyue.goetyominus.common.entities.ally.sar.ConfusionBolt;
...
public class ConfusionBoltSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.goetyominus.config.SpellConfig.ConfusionBoltSoulCost.get();
    }
    ...
    public int defaultSpellCooldown() {
        return com.qiuyue.goetyominus.config.SpellConfig.ConfusionBoltCooldown.get();
    }
