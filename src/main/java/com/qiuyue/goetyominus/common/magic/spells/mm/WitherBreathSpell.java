...
import com.qiuyue.goetyominus.common.entities.ally.mobs.mm.AreaDamage;
...
public class WitherBreathSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.goetyominus.config.SpellConfig.WitherBreathSoulCost.get();
    }
    ...
    public int defaultSpellCooldown() {
        return com.qiuyue.goetyominus.config.SpellConfig.WitherBreathCooldown.get();
    }
