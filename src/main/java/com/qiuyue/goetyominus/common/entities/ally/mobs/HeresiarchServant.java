...
import com.qiuyue.goetyominus.compat.mod.GoetyAwakenCompat;
import com.qiuyue.goetyominus.compat.mod.GoetyRevelationCompat;
...
public class HeresiarchServant extends CultistServant {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(0, new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/heresiarch_servant.png"));
        map.put(1, new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/heresiarch_servant_alt.png"));
    });
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(1, new com.qiuyue.goetyominus.common.entities.ai.HeresiarchServantBarterGoal(this) {
            public void start() {
                super.start();
    ...
    private void setGoetyAwakenEmpowered() {
        ...
        try {
            ...
            System.err.println("[GoetyOminous] Failed to set GoetyAwaken monolith empowered: " + e.getMessage());
        }
    }
    ...
    public @Nullable SpawnGroupData finalizeSpawn(ServerLevelAccessor worldIn, DifficultyInstance difficultyIn, MobSpawnType reason, @Nullable SpawnGroupData spawnDataIn, @Nullable CompoundTag dataTag) {
        ...
        if (!this.hasCustomName()) {
            ...
            Component component = Component.translatable("title.goetyominus.heresiarch_servant." + random);
            Component component1 = Component.translatable("name.goetyominus.heresiarch_servant." + random2);
    ...
    static class HysteriaGoal extends HeresiarchGoal {
        ...
        public boolean canUse() {
            if (!com.qiuyue.goetyominus.config.MobsConfig.HeresiarchHysteriaEnabled.get()) {
                return false;
            }
            ...
            if (this.blessTick == 30) {
                        ...
                        if (var4 instanceof ServerLevel serverLevel) {
                            ...
                            if (this.heresiarch.hasObsidianSoul()) {
                                try {
                                    ...
                                    System.err.println("[GoetyOminous] Failed to apply Buff effect: " + e.getMessage());
                                }
                            }
                ...
                if (this.heresiarch.hasObsidianSoul()) {
                    try {
                        ...
                        System.err.println("[GoetyOminous] Failed to apply Rallied effect: " + e.getMessage());
                    }
                }
            }
        }
