...
public class SkeletonVillagerServant extends AbstractSkeletonServant implements CrossbowAttackMob {
    ...
    public ItemStack getPickedResult(HitResult target) {
        return new ItemStack(com.qiuyue.goetyominus.common.items.sar.SarItems.SKELETON_VILLAGER_SERVANT_SPAWN_EGG.get());
    }
    ...
    public EntityType<?> getVariant(@Nullable Player player, Level level, BlockPos blockPos) {
        return com.qiuyue.goetyominus.common.init.sar.SarEntityRegistry.SKELETON_VILLAGER_SERVANT.get();
    }
