...
import com.qiuyue.goetyominus.common.entities.ai.AcolyteBarterGoal;
...
public class AcolyteServant extends CultistServant {
    ...
    public void setConfigurableAttributes() {
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.MAX_HEALTH),
                com.qiuyue.goetyominus.config.AttributesConfig.AcolyteHealth.get());
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ARMOR),
                com.qiuyue.goetyominus.config.AttributesConfig.AcolyteArmor.get());
        MobUtil.setBaseAttributes(this.getAttribute(Attributes.ATTACK_DAMAGE),
                com.qiuyue.goetyominus.config.AttributesConfig.AcolyteDamage.get());
    }
    ...
    protected SoundEvent getAmbientSound() {
        ...
        return switch (random) {
            case 0 -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_IDLE_1.get();
            case 1 -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_IDLE_2.get();
            case 2 -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_IDLE_3.get();
            case 3 -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_IDLE_4.get();
            default -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_IDLE_5.get();
        };
    }
    ...
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        ...
        return switch (random) {
            case 0 -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_HURT_1.get();
            case 1 -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_HURT_2.get();
            default -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_HURT_3.get();
        };
    }
    ...
    protected SoundEvent getDeathSound() {
        int random = this.random.nextInt(3);
        return switch (random) {
            case 0 -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_DEATH_1.get();
            case 1 -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_DEATH_2.get();
            default -> com.qiuyue.goetyominus.common.init.ModSounds.ACOLYTE_DEATH_3.get();
        };
    }
