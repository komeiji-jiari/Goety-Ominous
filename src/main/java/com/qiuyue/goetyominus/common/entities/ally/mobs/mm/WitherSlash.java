...
public class WitherSlash extends ThrowableProjectile {
    ...
    public WitherSlash(Level p_37399_, LivingEntity p_37400_, float yRot) {
        super(com.qiuyue.goetyominus.common.init.mm.MmEntityRegistry.WITHER_SLASH.get(), p_37400_, p_37399_);
                ...
                if (!this.alreadyHit.contains(target) && this.canHarm(target)) {
                    ...
                    if (target instanceof LivingEntity) {
                        ...
                        if (flag) {
                            ...
                            if (!this.weapon.isEmpty() && this.weapon.getItem() instanceof com.qiuyue.goetyominus.common.items.mm.WitherScytheItem) {
