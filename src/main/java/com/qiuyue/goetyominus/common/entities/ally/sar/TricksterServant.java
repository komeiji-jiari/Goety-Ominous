    ...
    public void tick() {
        ...
        this.entityData.get(PRISON_POS).ifPresent(pos -> {
            ...
            if (time > 0) {
                ...
                com.qiuyue.goetyominus.common.entities.ally.sar.RunePrison runePrison = new com.qiuyue.goetyominus.common.entities.ally.sar.RunePrison(this.level(), null, PRISON_TIME, false, this);
