...
public class ThunderHorn extends Item {
        ...
        if (worldIn instanceof ServerLevel serverWorld) {
            ...
            if (flag) {
                ...
                if (entityLiving instanceof Player) {
                    ...
                    player.displayClientMessage(Component.translatable("info.goetyominus.items.thunder_horn.failure"), true);
                }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("info.goetyominus.items.thunder_horn.desc").withStyle(ChatFormatting.DARK_PURPLE));
    }
}
