...
import com.qiuyue.goetyominus.client.render.model.TwittollagerServantModel;
import com.qiuyue.goetyominus.client.render.layer.TwittollagerPhoneLayer;
import com.qiuyue.goetyominus.common.entities.ally.illager.TwittollagerServant;
...
public class TwittollagerServantRenderer extends MobRenderer<TwittollagerServant, TwittollagerServantModel<TwittollagerServant>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("goetyominus", "textures/entity/illager/twittollager.png");
    private static final ResourceLocation URTSARTEXTURE = new ResourceLocation("goetyominus", "textures/entity/illager/twittollager_urtsar.png");
