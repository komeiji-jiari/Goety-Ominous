...
@OnlyIn(Dist.CLIENT)
public class ModelMurmurServantBody extends AdvancedEntityModel<MurmurServant> {
    private final AdvancedModelBox root;
    private final AdvancedModelBox body;
    private final AdvancedModelBox arms;

    public ModelMurmurServantBody() {
        this.texWidth = 128;
        this.texHeight = 128;
    ...
    public void setupAnim(MurmurServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        var10000.rotationPointY = (float)((double)var10000.rotationPointY - Math.abs(Math.sin((double)(0.9F * limbSwing)) * (double)limbSwingAmount * 4.0));
