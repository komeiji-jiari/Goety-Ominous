...
import com.qiuyue.goetyominus.client.render.model.AbsorberServantModel;
import com.qiuyue.goetyominus.common.entities.ally.illager.AbsorberServant;
...
public class AbsorberServantRenderer extends MobRenderer<AbsorberServant, AbsorberServantModel<AbsorberServant>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("goetyominus", "textures/entity/illager/absorber1.png");
    private static final ResourceLocation DEGRADE1 = new ResourceLocation("goetyominus", "textures/entity/illager/absorber2.png");
    private static final ResourceLocation DEGRADE2 = new ResourceLocation("goetyominus", "textures/entity/illager/absorber3.png");
    private static final ResourceLocation DEGRADE3 = new ResourceLocation("goetyominus", "textures/entity/illager/absorber4.png");
