...
import com.qiuyue.goetyominus.client.render.model.PiglinServantModel;
...
public class PiglinServantRenderer extends HumanoidMobRenderer<Mob, PiglinServantModel<Mob>> {
    ...
    static {
        TEXTURES = ImmutableMap.<EntityType<?>, ResourceLocation>builder()
                .put(com.qiuyue.goetyominus.common.init.ModEntityTypes.PIGLIN_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/piglin/piglin_servant.png"))
                .put(com.qiuyue.goetyominus.common.init.ModEntityTypes.PIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/piglin/piglin_brute_servant.png"))
                .put(com.qiuyue.goetyominus.common.init.ModEntityTypes.STRONG_PIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/piglin/piglin_brute_servant_strong.png"))
                .put(com.qiuyue.goetyominus.common.init.ModEntityTypes.ELITE_PIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/piglin/piglin_brute_servant_elite.png"))
                .put(com.qiuyue.goetyominus.common.init.ModEntityTypes.PIGLIN_HUNTER_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/piglin/piglin_brute_servant.png"))
                .put(com.qiuyue.goetyominus.common.init.ModEntityTypes.STRONG_PIGLIN_HUNTER_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/piglin/piglin_brute_servant_strong.png"))
                .put(com.qiuyue.goetyominus.common.init.ModEntityTypes.ELITE_PIGLIN_HUNTER_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/piglin/piglin_brute_servant_elite.png"))
                .put(com.qiuyue.goetyominus.common.init.ModEntityTypes.FUNGUS_THROWER.get(),
