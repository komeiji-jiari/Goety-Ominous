...
import com.qiuyue.goetyominus.client.render.model.animation.PiglinMerchantAnimations;
import com.qiuyue.goetyominus.common.entities.ally.mobs.PiglinMerchant;
...
public class PiglinMerchantModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation("goetyominus", "piglin_merchant"), "main");
