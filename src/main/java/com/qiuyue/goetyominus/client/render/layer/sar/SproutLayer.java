package com.qiuyue.goetyominus.client.render.layer.sar;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.qiuyue.goetyominus.GoetyOminous;
import com.qiuyue.goetyominus.common.entities.ally.sar.CreepieServant;
...
@OnlyIn(Dist.CLIENT)
public class SproutLayer<E extends CreepieServant, M extends EntityModel<E>> extends RenderLayer<E, M> {
    private static final ResourceLocation SPROUT_TEXTURE = new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/creepie_sprout.png");
