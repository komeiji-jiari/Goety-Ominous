...
import com.qiuyue.goetyominus.common.entities.ally.sar.ExecutionerServant;
...
public class ExecutionerServantModel extends HumanoidModel<ExecutionerServant> {
    ...
    public ExecutionerServantModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(ExecutionerServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        super.setupAnim(entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
        AbstractIllagerServant.IllagerServantArmPose illagerArmPose = entityIn.getArmPose();
        if (illagerArmPose == AbstractIllagerServant.IllagerServantArmPose.ATTACKING) {
        ...
        boolean isCrossed = illagerArmPose == AbstractIllagerServant.IllagerServantArmPose.CROSSED;
