...
public class CreepieServantModel extends ListModel<CreepieServant> {
    ...
    public CreepieServantModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(CreepieServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
