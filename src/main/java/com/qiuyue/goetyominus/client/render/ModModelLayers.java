...
import com.qiuyue.goetyominus.client.render.model.*;
import com.qiuyue.goetyominus.client.render.model.equipment.BoneCudgelModel;
...
import com.qiuyue.goetyominus.client.render.model.projectile.PitchforkModel;
import com.qiuyue.goetyominus.client.render.projectile.AcidFungusRenderer;
import com.qiuyue.goetyominus.common.init.ModEntityTypes;
import com.qiuyue.goetyominus.compat.mod.*;
import com.qiuyue.goetyominus.client.render.projectile.PitchforkRenderer;
import com.qiuyue.goetyominus.client.render.projectile.BurningPotionRenderer;
import com.qiuyue.goetyominus.client.render.projectile.WitchBombRenderer;
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        if (SavageRavageCompat.isSavageRavageLoaded()) {
            event.registerLayerDefinition(ModEntityLayers.CREEPIE_SERVANT_LAYER,
                    () -> com.qiuyue.goetyominus.client.render.model.sar.CreepieServantModel.createBodyLayer(
            ...
            event.registerLayerDefinition(ModEntityLayers.GRIEFER_SERVANT_LAYER,
                    com.qiuyue.goetyominus.client.render.model.sar.GrieferServantModel::createBodyLayer);

            event.registerLayerDefinition(ModEntityLayers.VILLAGER_INNER_ARMOR_LAYER,
                    com.qiuyue.goetyominus.client.render.model.sar.VillagerArmorModel::createInnerArmorLayer);

            event.registerLayerDefinition(ModEntityLayers.VILLAGER_OUTER_ARMOR_LAYER,
                    com.qiuyue.goetyominus.client.render.model.sar.VillagerArmorModel::createOuterArmorLayer);

            event.registerLayerDefinition(ModEntityLayers.EXECUTIONER_SERVANT_LAYER,
                    com.qiuyue.goetyominus.client.render.model.sar.ExecutionerServantModel::createBodyLayer);

            event.registerLayerDefinition(ModEntityLayers.SKELETON_VILLAGER_SERVANT_LAYER,
                    com.qiuyue.goetyominus.client.render.model.sar.SkeletonVillagerServantModel::createBodyLayer);

            event.registerLayerDefinition(ModEntityLayers.RUNE_PRISON_LAYER,
                    com.qiuyue.goetyominus.client.render.model.sar.RunePrisonModel::createBodyLayer);

            event.registerLayerDefinition(ModEntityLayers.TRICKSTER_SERVANT_LAYER,
                    com.qiuyue.goetyominus.client.render.model.sar.TricksterServantModel::createBodyLayer);
        }

        if (UpgradeAquaticCompat.isUpgradeAquaticLoaded()) {
            event.registerLayerDefinition(ModEntityLayers.THRASHER_SERVANT_LAYER,
                    com.qiuyue.goetyominus.client.render.model.ua.ThrasherServantModel::createBodyLayer);
            ...
            event.registerLayerDefinition(ModEntityLayers.FLARE_SERVANT_LAYER,
                    com.qiuyue.goetyominus.client.render.model.ua.FlareServantModel::createBodyLayer);
        }
        ...
        if (LegendaryMonstersCompat.isLegendaryMonstersLoaded()) {
            event.registerLayerDefinition(ModEntityLayers.OVERGROWN_COLOSSUS_SERVANT_LAYER,
                    com.qiuyue.goetyominus.client.render.model.lm.OvergrownColossusServantModel::createBodyLayer);
        }

        if (com.qiuyue.goetyominus.compat.mod.MutantMoreCompat.isMutantMoreLoaded()) {
            event.registerLayerDefinition(com.qiuyue.goetyominus.client.render.model.mm.MutantWitherSkeletonServantModel.MAIN,
                    com.qiuyue.goetyominus.client.render.model.mm.MutantWitherSkeletonServantModel::createBodyLayer);

            event.registerLayerDefinition(com.qiuyue.goetyominus.client.render.model.mm.MutantWitherSkeletonServantModel.INNER_ARMOUR,
                    com.alexander.mutantmore.advanced_animation_utils.armour_utils.AdvancedArmourLayer::createInnerArmourLayer);

            event.registerLayerDefinition(com.qiuyue.goetyominus.client.render.model.mm.MutantWitherSkeletonServantModel.OUTER_ARMOUR,
                    com.alexander.mutantmore.advanced_animation_utils.armour_utils.AdvancedArmourLayer::createOuterArmourLayer);

            event.registerLayerDefinition(com.qiuyue.goetyominus.client.init.ModEntityLayers.WITHER_SLASH_LAYER,
                    com.qiuyue.goetyominus.client.render.model.mm.WitherSlashModel::createBodyLayer);
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        if (IllageAndSpillageCompat.isIllageAndSpillageLoaded()) {
            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.TWITTOLLAGER_SERVANT.get(),
                    TwittollagerServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.ABSORBER_SERVANT.get(),
                    AbsorberServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.CRASHAGER_SERVANT.get(),
                    CrashagerServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.KABOOMER_SERVANT.get(),
                    KaboomerServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.ILLASHOOTER_SERVANT.get(),
                    IllashooterServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.DISPENSER_SERVANT.get(),
                    DispenserServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.FAKEMAGISPELLER.get(),
                    FakeMagispellerRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.MAGIHEAL.get(),
                    MagiHealRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.MAGIARROW.get(),
                    MagiArrowRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.MAGIFIREBALL.get(),
                    MagiFireballRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.compat.ias.IasEntityRegistry.MAGISPELLER_SERVANT.get(),
        ...
        event.registerEntityRenderer(ModEntityTypes.STORM_NECROMANCER.get(),
                com.qiuyue.goetyominus.client.render.StormNecromancerRenderer::new);
        ...
        if (SavageRavageCompat.isSavageRavageLoaded()) {
            event.registerEntityRenderer(
                    ...
                    com.qiuyue.goetyominus.client.render.sar.CreepieServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.sar.SarEntityRegistry.SPORE_CLOUD.get(),
                    com.qiuyue.goetyominus.client.render.sar.NoModelRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.sar.SarEntityRegistry.GRIEFER_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.sar.GrieferServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.sar.SarEntityRegistry.EXECUTIONER_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.sar.ExecutionerServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.sar.SarEntityRegistry.SKELETON_VILLAGER_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.sar.SkeletonVillagerServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.sar.SarEntityRegistry.RUNE_PRISON.get(),
                    com.qiuyue.goetyominus.client.render.sar.RunePrisonRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.sar.SarEntityRegistry.CONFUSION_BOLT.get(),
                    com.qiuyue.goetyominus.client.render.sar.NoModelRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.sar.SarEntityRegistry.TRICKSTER_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.sar.TricksterServantRenderer::new);
        }

        if (UpgradeAquaticCompat.isUpgradeAquaticLoaded()) {
            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.ua.UaEntityRegistry.THRASHER_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.ua.ThrasherServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.ua.UaEntityRegistry.GREAT_THRASHER_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.ua.ThrasherServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.ua.UaEntityRegistry.FLARE_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.ua.FlareServantRenderer::new);

        }

        if (LegendaryMonstersCompat.isLegendaryMonstersLoaded()) {
            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.lm.LmEntityRegistry.OVERGROWN_COLOSSUS_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.lm.OvergrownColossusServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.lm.LmEntityRegistry.POISONOUS_SHOCKWAVE.get(),
                    EmptyRenderer::new);
        }

        if (com.qiuyue.goetyominus.compat.mod.MutantMoreCompat.isMutantMoreLoaded()) {
            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.mm.MmEntityRegistry.MUTANT_WITHER_SKELETON_SERVANT.get(),
                    com.qiuyue.goetyominus.client.render.MutantWitherSkeletonServantRenderer::new);

            event.registerEntityRenderer(
                    com.qiuyue.goetyominus.common.init.mm.MmEntityRegistry.WITHER_SLASH.get(),
                    com.qiuyue.goetyominus.client.render.WitherSlashRenderer::new);
