...
@OnlyIn(Dist.CLIENT)
public class ModelDeepOneServant extends AdvancedEntityModel<DeepOneServant> implements ArmedModel {
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        this.animator.setAnimation(DeepOneServant.ANIMATION_THROW);
        ...
        this.animator.setAnimation(DeepOneServant.ANIMATION_SCRATCH);
        this.animator.startKeyframe(5);
        this.animator.rotate(this.jaw, (float) Math.toRadians(35.0), 0.0F, 0.0F);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(5);
        this.animator.setAnimation(DeepOneServant.ANIMATION_BITE);
        this.animator.startKeyframe(5);
        ...
        this.animator.setAnimation(DeepOneServant.ANIMATION_TRADE);
        this.animator.startKeyframe(10);
    ...
    @Override
    public void setupAnim(DeepOneServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lleg.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -2.5F, 5.0F, true)) - walkAmount * 1.0F;
        this.rleg.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -2.5F, 5.0F, false)) - walkAmount * 1.0F;
    ...
    /**
     * ACMath.walkValue 内联版:cos(limbSwing * speed + offset) * degree * amount * (inverse ? -1 : 1)
     */
