...
@OnlyIn(Dist.CLIENT)
public class ModelDeepOneKnightServant extends AdvancedEntityModel<DeepOneKnightServant> implements ArmedModel {
    ...
    public ModelDeepOneKnightServant() {
        this.texWidth = 128;
        this.texHeight = 128;
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        this.animator.setAnimation(DeepOneKnightServant.ANIMATION_THROW);
        ...
        this.animator.setAnimation(DeepOneKnightServant.ANIMATION_SCRATCH);
        this.animator.startKeyframe(5);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(5);
        this.animator.setAnimation(DeepOneKnightServant.ANIMATION_BITE);
        this.animator.startKeyframe(5);
        this.animator.rotate(this.lure, (float) Math.toRadians(-20.0), 0.0F, 0.0F);
        ...
        this.animator.setAnimation(DeepOneKnightServant.ANIMATION_TRADE);
        this.animator.startKeyframe(10);
        this.animator.move(this.head, 0.0F, -1.0F, -2.0F);
    ...
    @Override
    public void setupAnim(DeepOneKnightServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float bodyWalkBob = -Math.abs(this.walkValue(limbSwing, walkAmount, walkSpeed, -1.5F, 1.0F, false));
        float bodySwimBob = -this.walkValue(limbSwing, swimAmount, swimSpeed, 0.0F, 3.0F, false);
        this.body.rotationPointY += bodyWalkBob + bodySwimBob;
        this.lleg.rotationPointY -= bodyWalkBob;
        this.rleg.rotationPointY -= bodyWalkBob;
        this.lleg.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -2.6F, 5.0F, true)) - walkAmount * 2.0F;
        this.rleg.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, walkAmount, walkSpeed, -2.6F, 5.0F, false)) - walkAmount * 2.0F;
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.body, this.tail, this.head, this.jaw, this.rarm, this.larm,
                this.rleg, this.lleg, this.lfin, this.rfin, this.lure,
                this.cube_r1, this.cube_r2, this.cube_r3, this.cube_r4, this.cube_r5, this.cube_r6,
                this.cube_r7, this.cube_r7, this.cube_r8, this.cube_r9, this.cube_r10, this.cube_r11,
                this.cube_r12, this.cube_r13, this.cube_r14, this.cube_r15);
    }
