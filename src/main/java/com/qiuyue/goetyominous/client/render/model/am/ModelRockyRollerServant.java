...
@OnlyIn(Dist.CLIENT)
public class ModelRockyRollerServant extends AdvancedEntityModel<RockyRollerServant> {
    ...
    public ModelRockyRollerServant() {
        this.texWidth = 128;
        this.texHeight = 128;
    ...
    @Override
    public void setupAnim(RockyRollerServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.progressRotationPrev(this.left_arm, walkProgress * limbSwingAmount, Maths.rad(30.0D), 0.0F, 0.0F, 5.0F);
        this.progressRotationPrev(this.right_arm, walkProgress * limbSwingAmount, Maths.rad(30.0D), 0.0F, 0.0F, 5.0F);
        this.progressRotationPrev(this.tail, walkProgress * limbSwingAmount, Maths.rad(30.0D), 0.0F, 0.0F, 5.0F);
        ...
        if (entity.isRolling()) {
            ...
            float rollDeg = (float) Mth.wrapDegrees((double) Math.toDegrees(entity.clientRoll));
