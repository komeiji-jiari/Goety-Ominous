...
@OnlyIn(Dist.CLIENT)
public class ModelVallumraptorServant extends AdvancedEntityModel<VallumraptorServant> {
    ...
    public ModelVallumraptorServant() {
        texWidth = 64;
        texHeight = 64;
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        animator.setAnimation(VallumraptorServant.ANIMATION_CALL_1);
        ...
        animator.setAnimation(VallumraptorServant.ANIMATION_CALL_2);
        ...
        animator.setAnimation(VallumraptorServant.ANIMATION_SCRATCH_1);
        animator.startKeyframe(5);
        animatePose(1);
        animator.endKeyframe();
        ...
        animator.endKeyframe();
        animator.resetKeyframe(5);
        animator.setAnimation(VallumraptorServant.ANIMATION_SCRATCH_2);
        animator.startKeyframe(5);
        animatePose(2);
        animator.endKeyframe();
        animator.startKeyframe(2);
        ...
        animator.endKeyframe();
        animator.resetKeyframe(5);
        animator.setAnimation(VallumraptorServant.ANIMATION_STARTLEAP);
        animator.startKeyframe(5);
        ...
        animator.setAnimation(VallumraptorServant.ANIMATION_MELEE_BITE);
        ...
        animator.setAnimation(VallumraptorServant.ANIMATION_MELEE_SLASH_1);
        animator.startKeyframe(5);
        animatePose(3);
        ...
        animator.endKeyframe();
        animator.resetKeyframe(5);
        animator.setAnimation(VallumraptorServant.ANIMATION_MELEE_SLASH_2);
        animator.startKeyframe(5);
        animatePose(3);
        ...
        animator.endKeyframe();
        animator.resetKeyframe(5);
        animator.setAnimation(VallumraptorServant.ANIMATION_GRAB);
        animator.startKeyframe(5);
        animatePose(5);
    ...
    @Override
    public void setupAnim(VallumraptorServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    private void setupAnimForAnimation(VallumraptorServant entity, Animation animation, float limbSwing, float limbSwingAmount, float ageInTicks) {
        float partialTick = ageInTicks - entity.tickCount;
        if (animation == VallumraptorServant.ANIMATION_SHAKE) {
