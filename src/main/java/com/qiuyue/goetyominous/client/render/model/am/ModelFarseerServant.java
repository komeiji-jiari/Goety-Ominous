...
public class ModelFarseerServant extends AdvancedEntityModel<FarseerServant> {
    ...
    public ModelFarseerServant(float scale) {
        this.texWidth = 128;
        this.texHeight = 128;
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        this.animator.setAnimation(FarseerServant.ANIMATION_EMERGE);
    ...
    public void setupAnim(FarseerServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.leftArm.rotationPointX = this.leftArm.rotationPointX + (float) (topArmOffset.x + Math.sin(ageInTicks * idleSpeed + 1.3F)) * idleDegree;
        this.leftArm.rotationPointY = this.leftArm.rotationPointY + (float) (topArmOffset.y + Math.sin(ageInTicks * idleSpeed + 1.6F)) * idleDegree;
        this.leftArm.rotationPointZ = this.leftArm.rotationPointZ + (float) (topArmOffset.z + Math.cos(ageInTicks * idleSpeed + 1.9F)) * idleDegree;
        this.leftArm.rotateAngleY += armYaw;
        this.leftArm2.rotationPointX = this.leftArm2.rotationPointX + (float) (bottomArmOffset.x + Math.sin(ageInTicks * idleSpeed + 2.3F)) * idleDegree;
        this.leftArm2.rotationPointY = this.leftArm2.rotationPointY + (float) (bottomArmOffset.y + Math.sin(ageInTicks * idleSpeed + 2.6F)) * idleDegree;
        this.leftArm2.rotationPointZ = this.leftArm2.rotationPointZ + (float) (bottomArmOffset.z + Math.cos(ageInTicks * idleSpeed + 2.9F)) * idleDegree;
        this.leftArm2.rotateAngleY += armYaw;
        this.rightArm.rotationPointX = this.rightArm.rotationPointX + (float) (topArmOffset.x + Math.sin(ageInTicks * idleSpeed + 3.3F)) * idleDegree;
        this.rightArm.rotationPointY = this.rightArm.rotationPointY + (float) (topArmOffset.y + Math.sin(ageInTicks * idleSpeed + 3.6F)) * idleDegree;
        this.rightArm.rotationPointZ = this.rightArm.rotationPointZ + (float) (topArmOffset.z + Math.cos(ageInTicks * idleSpeed + 3.9F)) * idleDegree;
        this.rightArm.rotateAngleY += armYaw;
        this.rightArm2.rotationPointX = this.rightArm2.rotationPointX + (float) (bottomArmOffset.x + Math.sin(ageInTicks * idleSpeed + 4.3F)) * idleDegree;
        this.rightArm2.rotationPointY = this.rightArm2.rotationPointY + (float) (bottomArmOffset.y + Math.sin(ageInTicks * idleSpeed + 4.6F)) * idleDegree;
        this.rightArm2.rotationPointZ = this.rightArm2.rotationPointZ + (float) (bottomArmOffset.z + Math.cos(ageInTicks * idleSpeed + 4.9F)) * idleDegree;
        this.rightArm2.rotateAngleY += armYaw;
        this.bodyCube1.rotationPointX = this.bodyCube1.rotationPointX + (float) (body1Offset.x + Math.sin(ageInTicks * idleSpeed + 7.3F)) * idleDegree;
        this.bodyCube1.rotationPointY = this.bodyCube1.rotationPointY + (float) (body1Offset.y + Math.sin(ageInTicks * idleSpeed + 7.6F)) * idleDegree;
        this.bodyCube1.rotationPointZ = this.bodyCube1.rotationPointZ + (float) (body1Offset.z + Math.cos(ageInTicks * idleSpeed + 7.9F)) * idleDegree;
        this.bodyCube2.rotationPointX = this.bodyCube2.rotationPointX + (float) (body2Offset.x + Math.sin(ageInTicks * idleSpeed + 5.3F)) * idleDegree;
        this.bodyCube2.rotationPointY = this.bodyCube2.rotationPointY + (float) (body2Offset.y + Math.sin(ageInTicks * idleSpeed + 5.6F)) * idleDegree;
        this.bodyCube2.rotationPointZ = this.bodyCube2.rotationPointZ + (float) (body2Offset.z + Math.cos(ageInTicks * idleSpeed + 5.9F)) * idleDegree;
        this.head.rotationPointX = (float) (this.head.rotationPointX + angryShake.x);
        this.head.rotationPointY = (float) (this.head.rotationPointY + angryShake.y);
        this.head.rotationPointZ = (float) (this.head.rotationPointZ + angryShake.z);
