...
public class ModelWarpedMoscoServant extends AdvancedEntityModel<WarpedMoscoServant> {
    ...
    public ModelWarpedMoscoServant() {
        texWidth = 128;
        texHeight = 128;
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.setAnimation(WarpedMoscoServant.ANIMATION_PUNCH_R);
        ...
        animator.setAnimation(WarpedMoscoServant.ANIMATION_PUNCH_L);
        animator.startKeyframe(10);
        animator.rotate(chest,0,  Maths.rad(-40F), 0);
        ...
        animator.setStaticKeyframe(5);
        animator.resetKeyframe(5);
        animator.setAnimation(WarpedMoscoServant.ANIMATION_SLAM);
        animator.startKeyframe(10);
        ...
        animator.setAnimation(WarpedMoscoServant.ANIMATION_SUCK);
        animator.startKeyframe(10);
        animator.rotate(chest, Maths.rad(60F), 0, 0);
        animator.rotate(body, Maths.rad(40F), 0, 0);
        animator.rotate(head, Maths.rad(-60F), 0, 0);
        ...
        animator.resetKeyframe(10);
        animator.setAnimation(WarpedMoscoServant.ANIMATION_SPIT);
        animator.startKeyframe(5);
    ...
    @Override
    public void setupAnim(WarpedMoscoServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if(entity.getAnimation() != WarpedMoscoServant.ANIMATION_SUCK){
