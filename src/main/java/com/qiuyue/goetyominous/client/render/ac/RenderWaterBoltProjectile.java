...
@OnlyIn(Dist.CLIENT)
public class RenderWaterBoltProjectile extends EntityRenderer<WaterBoltProjectile> {
    ...
    private static final ModelWaterBoltProjectile MODEL = new ModelWaterBoltProjectile();

    public RenderWaterBoltProjectile(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(WaterBoltProjectile entity, float entityYaw, float partialTicks, PoseStack matrixStack,
    ...
    private void renderTrail(WaterBoltProjectile entity, float partialTicks, PoseStack matrixStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(WaterBoltProjectile entity) {
        return TEXTURE;
    }
}
