...
@OnlyIn(Dist.CLIENT)
public class ModelFroststalkerServant extends AdvancedEntityModel<FroststalkerServant> {
    ...
    public ModelFroststalkerServant() {
        texWidth = 128;
        texHeight = 128;
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.setAnimation(FroststalkerServant.ANIMATION_BITE);
        ...
        animator.setAnimation(FroststalkerServant.ANIMATION_SPEAK);
        ...
        animator.setAnimation(FroststalkerServant.ANIMATION_SLASH_L);
        ...
        animator.endKeyframe();
        animator.resetKeyframe(5);
        animator.setAnimation(FroststalkerServant.ANIMATION_SLASH_R);
        animator.startKeyframe(5);
        animator.rotate(body, Maths.rad(-15), Maths.rad(15), 0);
        animator.rotate(neck, Maths.rad(15), Maths.rad(-15), 0);
        animator.rotate(legright, Maths.rad(15), Maths.rad(-15), 0);
        ...
        animator.endKeyframe();
        animator.resetKeyframe(5);
        animator.setAnimation(FroststalkerServant.ANIMATION_SHOVE);
        animator.startKeyframe(5);
    ...
    @Override
    public void setupAnim(FroststalkerServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
