...
@OnlyIn(Dist.CLIENT)
public class ModelCorrodentServant extends AdvancedEntityModel<CorrodentServant> {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.root, this.rarmPivot, this.larmPivot, this.rarm, this.larm, this.chest, this.hips, this.hipsPivot, this.llegPivot, this.rlegPivot, this.lleg, this.rleg, this.head, this.snout, this.nose, this.tail, this.lwhisker, this.lwhisker_S, this.rwhisker, this.rwhisker_S, this.jaw);
    }

    public void animate(IAnimatedEntity entity) {
        this.animator.update(entity);
        this.animator.setAnimation(CorrodentServant.ANIMATION_BITE);
    ...
    @Override
    public void setupAnim(CorrodentServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.chest.rotateAngleX = (float) (this.chest.rotateAngleX + Math.toRadians(digPitch));
        this.hipsPivot.rotateAngleY = (float) (this.hipsPivot.rotateAngleY + Math.toRadians(Mth.wrapDegrees(tail1Y)) * (1.0F - afraidAmount));
        this.tail.rotateAngleY = (float) (this.tail.rotateAngleY + Math.toRadians(Mth.wrapDegrees(tail2Y)));
        this.hipsPivot.rotateAngleX = (float) (this.hipsPivot.rotateAngleX + Math.toRadians(Mth.wrapDegrees(tailX)) * (1.0F - afraidAmount));
        this.head.rotateAngleY = (float) (this.head.rotateAngleY + Math.toRadians(Mth.approachDegrees((float) defaultY, (float) (netHeadYaw + defaultY), 20.0F) - defaultY));
    }
}
