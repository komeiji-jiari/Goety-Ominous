...
import com.qiuyue.goetyominous.common.entities.ally.mobs.SunkenNecromancerServant;
...
public class StormNecromancerServantRenderer extends MobRenderer<SunkenNecromancerServant, SunkenNecromancerModel<SunkenNecromancerServant>> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/storm_necromancer/storm_necromancer_servant.png");
    private static final ResourceLocation GLOW_TEXTURE = new ResourceLocation(GoetyOminous.MOD_ID, "textures/entity/storm_necromancer/storm_necromancer_glow.png");
