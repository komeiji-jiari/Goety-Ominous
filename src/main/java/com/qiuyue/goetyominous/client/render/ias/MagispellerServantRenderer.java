...
import com.qiuyue.goetyominous.client.render.layer.ias.*;
...
public class MagispellerServantRenderer extends MobRenderer<MagispellerServant, MagispellerServantModel<MagispellerServant>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("goetyominous", "textures/entity/illager/magispeller.png");
