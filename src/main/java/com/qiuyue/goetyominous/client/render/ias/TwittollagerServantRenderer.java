...
import com.qiuyue.goetyominous.client.render.layer.TwittollagerPhoneLayer;
import com.qiuyue.goetyominous.common.entities.ally.ias.TwittollagerServant;
...
public class TwittollagerServantRenderer extends MobRenderer<TwittollagerServant, TwittollagerServantModel<TwittollagerServant>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("goetyominous", "textures/entity/illager/twittollager.png");
    private static final ResourceLocation URTSARTEXTURE = new ResourceLocation("goetyominous", "textures/entity/illager/twittollager_urtsar.png");
