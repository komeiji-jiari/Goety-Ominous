...
public class ModelTremorzillaServant extends AdvancedEntityModel<TremorzillaServant> {
    ...
    private final AdvancedModelBox tail1Spikes;
    private final AdvancedModelBox tail1Spike1;
    private final AdvancedModelBox tail1Spike2;
    private final AdvancedModelBox tail2;
    private final AdvancedModelBox tail2Spikes;
    private final AdvancedModelBox tail3;
    private final AdvancedModelBox tail3Spikes;
    ...
    public ModelTremorzillaServant() {
        this.texWidth = 512;
        this.texHeight = 512;
        ...
        this.tail1Spikes = new AdvancedModelBox(this);
        ...
        this.tail1Spike1 = new AdvancedModelBox(this);
        ...
        this.tail1Spike2 = new AdvancedModelBox(this);
        ...
        this.tail2Spikes = new AdvancedModelBox(this);
        ...
        this.tail3Spikes = new AdvancedModelBox(this);
    ...
    public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        if (this.young) {
            ...
            matrixStackIn.translate(0.0D, 8.55F, 0.0D);
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        this.animator.setAnimation(TremorzillaServant.ANIMATION_SPEAK);
        ...
        this.animator.setAnimation(TremorzillaServant.ANIMATION_ROAR_1);
        ...
        this.animator.setAnimation(TremorzillaServant.ANIMATION_ROAR_2);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.neck, (float) Math.toRadians(15.0), 0.0F, 0.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(20.0), 0.0F, 0.0F);
        this.animator.rotate(this.chest, (float) Math.toRadians(10.0), 0.0F, 0.0F);
        ...
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(TremorzillaServant.ANIMATION_RIGHT_SCRATCH);
        this.animator.startKeyframe(10);
        ...
        this.animator.setStaticKeyframe(5);
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(TremorzillaServant.ANIMATION_LEFT_SCRATCH);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.chest, (float) Math.toRadians(-15.0), (float) Math.toRadians(-15.0), 0.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(15.0), (float) Math.toRadians(15.0), 0.0F);
        ...
        this.animator.setStaticKeyframe(5);
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(TremorzillaServant.ANIMATION_RIGHT_STOMP);
        this.animator.startKeyframe(10);
        ...
        this.animator.setStaticKeyframe(5);
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(TremorzillaServant.ANIMATION_LEFT_STOMP);
        this.animator.startKeyframe(10);
        this.animator.move(this.torso, 0.0F, -20.0F, 2.0F);
        ...
        this.animator.setStaticKeyframe(5);
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(TremorzillaServant.ANIMATION_BITE);
        this.animator.startKeyframe(5);
        this.animator.rotate(this.chest, (float) Math.toRadians(-5.0), 0.0F, 0.0F);
        this.animator.rotate(this.neck, (float) Math.toRadians(-5.0), 0.0F, 0.0F);
        this.animator.endKeyframe();
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(TremorzillaServant.ANIMATION_PREPARE_BREATH);
        this.animator.startKeyframe(13);
        this.animator.move(this.neck, 0.0F, 10.0F, -5.0F);
        ...
        this.animator.setStaticKeyframe(2);
        this.animator.resetKeyframe(5);
        this.animator.setAnimation(TremorzillaServant.ANIMATION_CHEW);
    ...
    @Override
    public void setupAnim(TremorzillaServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float swimProgress = entity.getSwimAmount(partialTicks) * (1.0F - sitProgress);
        ...
        float spikes4Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 3.0F);
        float spikes5Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 4.0F);
        float spikes6Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 5.0F);
        ...
        if (burnProgress > 0.0F && burnPos != null) {
            ...
            Vec3 vector3d3 = new Vec3(vector3d.x - vector3d1.x, 0.0, vector3d.z - vector3d1.z).normalize().yRot(1.5707964F);
    ...
    public void showSpikesBasedOnProgress(float spikesDownProgress, float threshold) {
        boolean spikes1Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 0.0F) > threshold;
        boolean spikes2Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 1.0F) > threshold;
        boolean spikes3Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 2.0F) > threshold;
        boolean spikes4Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 3.0F) > threshold;
        boolean spikes5Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 4.0F) > threshold;
        boolean spikes6Down = TremorzillaServant.calculateSpikesDownAmountAtIndex(spikesDownProgress, 6.0F, 5.0F) > threshold;
    ...
    private void positionTail(TremorzillaServant entity, float partialTicks) {
    ...
    private void animateDancing(TremorzillaServant entity, float danceAmount, float ageInTicks) {
    ...
    private void setupAnimForAnimation(TremorzillaServant entity, Animation animation, float limbSwing, float limbSwingAmount, float ageInTicks) {
        float partialTick = ageInTicks - (float) entity.tickCount;
        if (entity.getAnimation() == TremorzillaServant.ANIMATION_ROAR_1 || entity.getAnimation() == TremorzillaServant.ANIMATION_ROAR_2) {
            float animationIntensity = 0.0F;
            float neckSide = 1.0F;
            if (entity.getAnimation() == TremorzillaServant.ANIMATION_ROAR_1) {
    ...
    public Vec3 getMouthPosition(Vec3 offsetIn) {
        ...
        return vec3.add(0.0D, 1.25D, 0.0D);
    }
