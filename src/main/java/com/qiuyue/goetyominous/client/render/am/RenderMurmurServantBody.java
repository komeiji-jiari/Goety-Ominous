...
import com.qiuyue.goetyominous.client.render.model.am.ModelMurmurServantBody;
...
public class RenderMurmurServantBody extends MobRenderer<MurmurServant, ModelMurmurServantBody> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("goetyominous", "textures/entity/murmur.png");
    public static final ResourceLocation TEXTURE_ANGRY = new ResourceLocation("goetyominous", "textures/entity/murmur_angry.png");
    public static final ResourceLocation SEKIBANKI_TEXTURE = new ResourceLocation("goetyominous", "textures/entity/sekibanki.png");
