...
public class ModelHullbreakerServant extends AdvancedEntityModel<HullbreakerServant> {
    ...
    public ModelHullbreakerServant() {
        this.texWidth = 512;
        this.texHeight = 512;
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.root, this.body, this.body2, this.tail, this.head, this.tail, this.tail2, this.tail3, this.dorsal, this.dorsal2, this.jaw, this.rbarb, this.rbarb2, this.rbarbLure, this.lbarb, this.lbarb2, this.lbarbLure, this.teeth1, this.teeth2, this.teeth3, this.teeth4, this.teeth5, this.rflipper, this.lflipper);
    }
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        this.animator.setAnimation(HullbreakerServant.ANIMATION_PUZZLE);
        this.animator.startKeyframe(10);
        this.animator.move(this.head, -5.0F, -5.0F, 0.0F);
        this.animator.rotate(this.head, 0.0F, (float) Math.toRadians(-5.0F), (float) Math.toRadians(-20.0F));
        ...
        this.animator.setAnimation(HullbreakerServant.ANIMATION_BITE);
        this.animator.startKeyframe(10);
        this.animator.move(this.head, 0.0F, -2.0F, 10.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(-40.0F), 0.0F, 0.0F);
        this.animator.rotate(this.jaw, (float) Math.toRadians(80.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.move(this.body, 0.0F, 0.0F, -10.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(-10.0F), 0.0F, 0.0F);
        this.animator.rotate(this.jaw, (float) Math.toRadians(10.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.resetKeyframe(5);
        this.animator.setAnimation(HullbreakerServant.ANIMATION_BASH);
        this.animator.startKeyframe(10);
        this.animator.move(this.head, 0.0F, -11.0F, -3.0F);
        this.animator.rotate(this.body, (float) Math.toRadians(-15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.body2, (float) Math.toRadians(15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(50.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.move(this.body, 0.0F, -5.0F, -20.0F);
        this.animator.move(this.head, 0.0F, -9.0F, -3.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(30.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(HullbreakerServant.ANIMATION_DIE);
        this.animator.startKeyframe(10);
        this.animator.move(this.head, 0.0F, -2.0F, 10.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(-40.0F), 0.0F, 0.0F);
        this.animator.rotate(this.jaw, (float) Math.toRadians(80.0F), 0.0F, 0.0F);
        this.animator.rotate(this.body, 0.0F, 0.0F, (float) Math.toRadians(5.0F));
        this.animator.endKeyframe();
        this.animator.startKeyframe(35);
        this.animator.move(this.head, 0.0F, -2.0F, 10.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(-30.0F), 0.0F, (float) Math.toRadians(-20.0F));
        this.animator.rotate(this.jaw, (float) Math.toRadians(40.0F), 0.0F, 0.0F);
    ...
    @Override
    public void setupAnim(HullbreakerServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float clampedYaw = netHeadYaw / (180F / (float) Math.PI);
        float fishPitchAmount = entity.getFishPitch(partialTicks) / (180F / (float) Math.PI);
        float headPitchAmount = headPitch / (180F / (float) Math.PI);
        ...
        var10000.rotationPointY -= ACMath.walkValue(ageInTicks, 1.0F, idleSpeed, 1.5F, 3.0F, true) * stillAmount;
        ...
        var10000 = this.body;
        var10000.rotationPointY -= ACMath.walkValue(limbSwingAmount, 1.0F, swimSpeed, 1.5F, 6.0F, true);
        ...
        this.progressRotationPrev(this.head, landProgress, (float) Math.toRadians(-10.0F), 0.0F, (float) Math.toRadians(30.0F), 1.0F);
        this.progressRotationPrev(this.body, landProgress, 0.0F, 0.0F, (float) Math.toRadians(-40.0F), 1.0F);
        this.progressRotationPrev(this.body2, landProgress, 0.0F, 0.0F, (float) Math.toRadians(-30.0F), 1.0F);
        this.progressRotationPrev(this.tail, landProgress, 0.0F, (float) Math.toRadians(-10.0F), (float) Math.toRadians(-20.0F), 1.0F);
        this.progressRotationPrev(this.tail2, landProgress, 0.0F, (float) Math.toRadians(5.0F), 0.0F, 1.0F);
        this.progressRotationPrev(this.rflipper, landProgress, 0.0F, (float) Math.toRadians(40.0F), 0.0F, 1.0F);
        this.progressRotationPrev(this.lflipper, landProgress, 0.0F, (float) Math.toRadians(-40.0F), 0.0F, 1.0F);
        this.progressRotationPrev(this.rbarb, landProgress, (float) Math.toRadians(20.0F), 0.0F, (float) Math.toRadians(-60.0F), 1.0F);
        this.progressRotationPrev(this.lbarb, landProgress, 0.0F, 0.0F, (float) Math.toRadians(-40.0F), 1.0F);
        var10000 = this.body;
        var10000.rotateAngleX += fishPitchAmount * 0.75F;
        var10000 = this.head;
        var10000.rotateAngleX += headPitchAmount;
        var10000 = this.head;
        var10000.rotateAngleY += clampedYaw;
        if (!this.straighten) {
            var10000 = this.body2;
            var10000.rotateAngleX = (float) ((double) var10000.rotateAngleX + Math.toRadians(entity.tail1Part.calculateAnimationAngle(partialTicks, true)));
            var10000 = this.body2;
            var10000.rotateAngleY = (float) ((double) var10000.rotateAngleY + Math.toRadians(entity.tail1Part.calculateAnimationAngle(partialTicks, false)));
            var10000 = this.tail;
            var10000.rotateAngleX = (float) ((double) var10000.rotateAngleX + Math.toRadians(entity.tail2Part.calculateAnimationAngle(partialTicks, true)));
            var10000 = this.tail;
            var10000.rotateAngleY = (float) ((double) var10000.rotateAngleY + Math.toRadians(entity.tail2Part.calculateAnimationAngle(partialTicks, false)));
            ...
            var10000 = this.tail2;
            var10000.rotateAngleX = (float) ((double) var10000.rotateAngleX + Math.toRadians(tail2XRot));
            var10000 = this.tail2;
            var10000.rotationPointZ -= 5.0F * Math.abs(tail2XRot / 20.0F);
            var10000 = this.tail2;
            var10000.rotateAngleY = (float) ((double) var10000.rotateAngleY + Math.toRadians(entity.tail3Part.calculateAnimationAngle(partialTicks, false)));
            var10000 = this.tail3;
            var10000.rotateAngleX = (float) ((double) var10000.rotateAngleX + Math.toRadians(tail3XRot));
            var10000 = this.tail3;
            var10000.rotationPointZ -= 5.0F * Math.abs(tail3XRot / 20.0F);
            var10000 = this.tail3;
            var10000.rotateAngleY = (float) ((double) var10000.rotateAngleY + Math.toRadians(entity.tail4Part.calculateAnimationAngle(partialTicks, false)));
            var10000 = this.lbarb;
            var10000.rotateAngleY = (float) ((double) var10000.rotateAngleY + Math.toRadians(entity.getYawFromBuffer(2, partialTicks) - bodyYRot));
            var10000 = this.rbarb;
            var10000.rotateAngleY = (float) ((double) var10000.rotateAngleY + Math.toRadians(entity.getYawFromBuffer(2, partialTicks) - bodyYRot));
            var10000 = this.lbarb2;
            var10000.rotateAngleY = (float) ((double) var10000.rotateAngleY + Math.toRadians(entity.getYawFromBuffer(4, partialTicks) - bodyYRot));
            var10000 = this.rbarb2;
            var10000.rotateAngleY = (float) ((double) var10000.rotateAngleY + Math.toRadians(entity.getYawFromBuffer(4, partialTicks) - bodyYRot));
        }
    }
}
