...
@OnlyIn(Dist.CLIENT)
public class ModelDeepOneMageServantWave extends AdvancedEntityModel<DeepOneMageServantWave> {

    private final AdvancedModelBox main;
    private final AdvancedModelBox top;

    public ModelDeepOneMageServantWave() {
        this.texWidth = 128;
        this.texHeight = 128;
    ...
    @Override
    public void setupAnim(DeepOneMageServantWave entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.progressRotationPrev(this.top, slam, (float) Math.toRadians(100.0F), 0.0F, 0.0F, 1.0F);
        this.progressPositionPrev(this.top, slam, 0.0F, -1.0F, 13.0F, 1.0F);
        AdvancedModelBox top = this.top;
        top.rotateAngleX += f;
        top.rotationPointY += f * 8.0F;
        top.rotationPointZ += f * 2.0F;
        ...
        top.rotationPointY += stretch * 2.0F;
        top.rotationPointZ += stretch * 2.0F;
    }
