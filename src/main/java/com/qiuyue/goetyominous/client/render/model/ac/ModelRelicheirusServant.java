...
@OnlyIn(Dist.CLIENT)
public class ModelRelicheirusServant extends AdvancedEntityModel<RelicheirusServant> {
    ...
    public ModelRelicheirusServant() {
        this.texWidth = 256;
        this.texHeight = 256;
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.body, this.chest, this.chestFeathers, this.tail, this.tail2, this.tailFeathers,
                this.neck, this.neckFeathers, this.head, this.jaw, this.hips, this.lwattle, this.rwattle, this.lleg,
                this.lleg2, this.rleg, this.rleg2, this.rfoot, this.lfoot, this.rarm, this.rarmFeathers, this.larm,
                this.larmFeathers, this.rhand, this.rhandClaw1, this.rhandClaw2, this.rhandClaw3, this.lhand,
                this.lhandClaw1, this.lhandClaw2, this.lhandClaw3, this.rclaw1, this.rclaw2, this.rclaw3,
                this.claw1, this.claw2, this.claw3);
    }

    public void animate(IAnimatedEntity entity) {
        this.animator.update(entity);
        this.animator.setAnimation(RelicheirusServant.ANIMATION_SPEAK_1);
        ...
        this.animator.setAnimation(RelicheirusServant.ANIMATION_SPEAK_2);
        this.animator.startKeyframe(5);
        this.animatePose(0);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(5);
        this.animator.setAnimation(RelicheirusServant.ANIMATION_EAT_TREE);
        this.animator.startKeyframe(5);
        this.animatePose(1);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        ...
        this.animator.setAnimation(RelicheirusServant.ANIMATION_EAT_TRILOCARIS);
        this.animator.startKeyframe(10);
        this.animatePose(2);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(RelicheirusServant.ANIMATION_PUSH_TREE);
        this.animator.startKeyframe(15);
        this.animatePose(1);
        this.animator.rotate(this.lhand, 0.0F, 0.0F, (float) Math.toRadians(10.0));
        this.animator.rotate(this.rhand, 0.0F, 0.0F, (float) Math.toRadians(-10.0));
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(5);
        this.animator.setAnimation(RelicheirusServant.ANIMATION_SCRATCH_1);
        this.animator.startKeyframe(10);
        this.animatePose(1);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(RelicheirusServant.ANIMATION_SCRATCH_2);
        this.animator.startKeyframe(10);
        this.animatePose(1);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(RelicheirusServant.ANIMATION_MELEE_SLASH_1);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(RelicheirusServant.ANIMATION_MELEE_SLASH_2);
        this.animator.startKeyframe(7);
        this.animatePose(1);
        this.animator.rotate(this.body, 0.0F, (float) Math.toRadians(-15.0), 0.0F);
        this.animator.rotate(this.neck, (float) Math.toRadians(15.0), 0.0F, 0.0F);
    ...
    private void setupAnimForAnimation(RelicheirusServant entity, Animation animation, float limbSwing, float bodyDown, float ageInTicks) {
        float animationIntensity;
        float partialTick = ageInTicks - (float) entity.tickCount;
        if (animation == RelicheirusServant.ANIMATION_SHAKE) {
        ...
        if (animation == RelicheirusServant.ANIMATION_EAT_TREE || animation == RelicheirusServant.ANIMATION_EAT_TRILOCARIS) {
            animationIntensity = animation == RelicheirusServant.ANIMATION_EAT_TRILOCARIS
                    ? ACMath.cullAnimationTick(entity.getAnimationTick(), 2.0F, animation, partialTick, 15, 30)
                    : ACMath.cullAnimationTick(entity.getAnimationTick(), 3.0F, animation, partialTick, 0);
            float peckY = (float) ((double) entity.getPeckY() - (entity.getEyePosition(partialTick).y - (double) (bodyDown / 16.0F)));
            ...
            this.neck.rotationPointZ += Math.abs(peckYPixel * 16.0F * 0.35F);
        }
    }

    @Override
    public void setupAnim(RelicheirusServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lleg.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, limbSwingAmount, walkSpeed, -0.5F, walkDegree * 10.0F, true));
        ...
        this.rleg.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, limbSwingAmount, walkSpeed, -0.5F, walkDegree * 10.0F, false));
        ...
        this.rarm.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, limbSwingAmount, walkSpeed, -0.5F, walkDegree * 10.0F, true)) * armsWalkAmount;
        this.rhand.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, limbSwingAmount, walkSpeed, 1.5F, walkDegree * 4.0F, true)) * armsWalkAmount;
        ...
        this.larm.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, limbSwingAmount, walkSpeed, -0.5F, walkDegree * 10.0F, false)) * armsWalkAmount;
        this.lhand.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, limbSwingAmount, walkSpeed, 1.5F, walkDegree * 4.0F, false)) * armsWalkAmount;
