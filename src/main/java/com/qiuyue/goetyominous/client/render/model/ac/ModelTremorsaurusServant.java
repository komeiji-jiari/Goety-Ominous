...
public class ModelTremorsaurusServant extends AdvancedEntityModel<TremorsaurusServant> {
    ...
    public ModelTremorsaurusServant() {
        this.texWidth = 256;
        this.texHeight = 256;
    ...
    public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        if (this.young) {
            ...
            matrixStackIn.translate(0.0D, 4.5D, 0.0D);
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.body, this.neck, this.head, this.jaw, this.glasses, this.tail, this.tailTip, this.rarm, this.larm, this.rleg, this.rleg2, this.rfoot, this.rclaw1, this.rclaw2, this.rclaw3, this.lleg, this.lleg2, this.lfoot, this.lclaw1, this.lclaw2, this.lclaw3);
    }
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        this.animator.setAnimation(TremorsaurusServant.ANIMATION_SNIFF);
        this.animator.startKeyframe(5);
        this.animator.rotate(this.neck, toRad(10.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, toRad(-15.0F), 0.0F, 0.0F);
        ...
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.rotate(this.neck, toRad(-5.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, toRad(-15.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.rotate(this.neck, toRad(-10.0F), 0.0F, 0.0F);
        ...
        this.animator.setAnimation(TremorsaurusServant.ANIMATION_SPEAK);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(5);
        this.animator.setAnimation(TremorsaurusServant.ANIMATION_ROAR);
        this.animator.startKeyframe(5);
        this.animator.move(this.lleg, 0.0F, -1.5F, 0.0F);
        this.animator.move(this.rleg, 0.0F, -1.5F, 0.0F);
        this.animator.rotate(this.body, toRad(-15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.lleg, toRad(15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.rleg, toRad(15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.neck, toRad(5.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, toRad(15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.tail, toRad(5.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(10);
        this.animatePose(0);
        this.animator.rotate(this.neck, 0.0F, toRad(30.0F), 0.0F);
        this.animator.rotate(this.head, 0.0F, toRad(20.0F), toRad(-20.0F));
        this.animator.rotate(this.jaw, toRad(60.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        ...
        this.animator.setAnimation(TremorsaurusServant.ANIMATION_BITE);
        this.animator.startKeyframe(5);
        this.animator.rotate(this.neck, toRad(-15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, toRad(15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.jaw, toRad(10.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.move(this.neck, 0.0F, 1.0F, -4.0F);
        this.animator.move(this.head, 0.0F, -3.0F, 1.0F);
        this.animator.rotate(this.neck, toRad(35.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, toRad(-45.0F), 0.0F, 0.0F);
        this.animator.rotate(this.jaw, toRad(70.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.resetKeyframe(5);
        this.animator.setAnimation(TremorsaurusServant.ANIMATION_SHAKE_PREY);
        this.animator.startKeyframe(5);
        this.animatePose(0);
        this.animator.rotate(this.jaw, toRad(40.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.rotate(this.jaw, toRad(40.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
    ...
    private void animatePose(int pose) {
        switch (pose) {
            case 0:
                ...
                this.animator.rotate(this.body, toRad(30.0F), 0.0F, 0.0F);
                this.animator.rotate(this.lleg, toRad(-30.0F), 0.0F, 0.0F);
                this.animator.rotate(this.rleg, toRad(-30.0F), 0.0F, 0.0F);
                this.animator.rotate(this.neck, toRad(-25.0F), 0.0F, 0.0F);
                this.animator.rotate(this.head, toRad(-15.0F), 0.0F, 0.0F);
                this.animator.rotate(this.tail, toRad(-10.0F), 0.0F, 0.0F);
                this.animator.rotate(this.tailTip, toRad(-10.0F), 0.0F, 0.0F);
            default:
        }
    }

    private void setupAnimForAnimation(TremorsaurusServant entity, Animation animation, float limbSwing, float limbSwingAmount, float ageInTicks) {
        float partialTick = ageInTicks - (float) entity.tickCount;
        if (entity.getAnimation() == TremorsaurusServant.ANIMATION_ROAR) {
        ...
        if (entity.getAnimation() == TremorsaurusServant.ANIMATION_SHAKE_PREY) {
    ...
    @Override
    public void setupAnim(TremorsaurusServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.progressRotationPrev(this.rleg, sitAmount, toRad(-20.0F), toRad(15.0F), 0.0F, 1.0F);
        this.progressRotationPrev(this.rleg2, sitAmount, toRad(-50.0F), 0.0F, 0.0F, 1.0F);
        this.progressRotationPrev(this.rfoot, sitAmount, toRad(70.0F), 0.0F, 0.0F, 1.0F);
