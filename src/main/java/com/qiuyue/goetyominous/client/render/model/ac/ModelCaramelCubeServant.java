...
public class ModelCaramelCubeServant extends AdvancedEntityModel<CaramelCubeServant> {
    ...
    public ModelCaramelCubeServant() {
        texWidth = 64;
        texHeight = 64;
    ...
    @Override
    public void setupAnim(CaramelCubeServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
