...
@OnlyIn(Dist.CLIENT)
public class ModelLuxtructosaurusServant extends AdvancedEntityModel<LuxtructosaurusServant> {
    ...
    public ModelLuxtructosaurusServant() {
        this.texWidth = 512;
        this.texHeight = 512;
    ...
    private void animate(LuxtructosaurusServant entity) {
        this.animator.update(entity);
        this.animator.setAnimation(LuxtructosaurusServant.ANIMATION_SPEAK);
        ...
        this.animator.setAnimation(LuxtructosaurusServant.ANIMATION_ROAR);
        ...
        this.animator.setAnimation(LuxtructosaurusServant.ANIMATION_EPIC_DEATH);
        this.animator.startKeyframe(5);
        this.animator.rotate(this.head, (float) Math.toRadians(10.0), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        ...
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(LuxtructosaurusServant.ANIMATION_SPEW_FLAMES);
        this.animator.startKeyframe(5);
        this.animator.rotate(this.head, (float) Math.toRadians(10.0), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        ...
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(LuxtructosaurusServant.ANIMATION_JUMP);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(LuxtructosaurusServant.ANIMATION_LEFT_KICK);
        ...
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(LuxtructosaurusServant.ANIMATION_RIGHT_KICK);
        this.animator.startKeyframe(5);
    ...
    public void setupAnim(LuxtructosaurusServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    private void setupAnimForAnimation(LuxtructosaurusServant entity, Animation animation, float ageInTicks) {
        float partialTick = ageInTicks - (float) entity.tickCount;
        if (entity.getAnimation() == LuxtructosaurusServant.ANIMATION_ROAR) {
        ...
        if (entity.getAnimation() == LuxtructosaurusServant.ANIMATION_EPIC_DEATH) {
        ...
        if (entity.getAnimation() == LuxtructosaurusServant.ANIMATION_SPEW_FLAMES) {
    ...
    private void positionNeckAndTail(LuxtructosaurusServant entity, float netHeadYaw, float headPitch, float partialTicks) {
        if (!entity.isFakeEntity()) {
            ...
            float pitchAmount = entity.getAnimation() == LuxtructosaurusServant.ANIMATION_SPEW_FLAMES ? 0.0F : Mth.clamp(headPitch, -30.0F, 30.0F) / 57.295776F;
    ...
    public Vec3 getRiderPosition(Vec3 offsetIn) {
        ...
        Vector4f riderOffsetVec = new Vector4f((float) offsetIn.x, (float) offsetIn.y, (float) offsetIn.z, 1.0F);
        riderOffsetVec.mul(translationStack.last().pose());
        Vec3 vec3 = new Vec3(riderOffsetVec.x(), riderOffsetVec.y(), riderOffsetVec.z());
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.root, this.body, this.chest, this.hips, this.tail, this.tail2, this.tail3,
                ...
                this.cube_r7, this.cube_r8, this.cube_r9, this.cube_r10);
    }

    public AdvancedModelBox getRandomModelPart(RandomSource randomSource) {
        List<AdvancedModelBox> parts = new ArrayList<>();
        this.getAllParts().forEach(parts::add);
        return parts.get(randomSource.nextInt(parts.size()));
    }
}
