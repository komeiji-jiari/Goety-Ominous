...
import com.qiuyue.goetyominous.common.entities.ally.sar.SkeletonVillagerServant;
...
@OnlyIn(Dist.CLIENT)
public class SkeletonVillagerServantModel extends HumanoidModel<SkeletonVillagerServant> {
    public ModelPart middleClosedArm;
    public ModelPart nose;
    public ModelPart rightClosedArm;
    public ModelPart leftClosedArm;

    public SkeletonVillagerServantModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(SkeletonVillagerServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public void prepareMobModel(SkeletonVillagerServant entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
        ItemStack itemstack = entityIn.getMainHandItem();
