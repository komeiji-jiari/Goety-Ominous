...
public class ModelTusklinServant extends AdvancedEntityModel<TusklinServant> {
   ...
   public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
      ...
      this.animator.setAnimation(TusklinServant.ANIMATION_RUT);
      this.animator.startKeyframe(4);
      this.animator.move(this.head, 0.0F, 4.0F, 0.0F);
      this.animator.rotate(this.head, Maths.rad(30.0D), 0.0F, 0.0F);
      this.animator.rotate(this.ear_left, 0.0F, 0.0F, Maths.rad(-30.0D));
      this.animator.rotate(this.ear_right, 0.0F, 0.0F, Maths.rad(30.0D));
      this.animator.endKeyframe();
      this.animator.startKeyframe(2);
      this.animator.move(this.head, -1.0F, 3.0F, 0.0F);
      this.animator.rotate(this.head, Maths.rad(40.0D), Maths.rad(30.0D), 0.0F);
      this.animator.rotate(this.ear_left, 0.0F, 0.0F, Maths.rad(-30.0D));
      this.animator.rotate(this.ear_right, 0.0F, 0.0F, Maths.rad(30.0D));
      this.animator.endKeyframe();
      this.animator.startKeyframe(4);
      ...
      this.animator.setAnimation(TusklinServant.ANIMATION_GORE_L);
      ...
      this.animator.rotate(this.arm_right, Maths.rad(-30.0D), 0.0F, 0.0F);
      this.animator.rotate(this.arm_left, Maths.rad(-30.0D), 0.0F, 0.0F);
      this.animator.move(this.head, 0.0F, 2.0F, -2.0F);
      this.animator.rotate(this.head, Maths.rad(40.0D), Maths.rad(-45.0D), Maths.rad(-90.0D));
      this.animator.endKeyframe();
      this.animator.startKeyframe(5);
      this.animator.move(this.body, 0.0F, 0.0F, -2.0F);
      this.animator.rotate(this.head, Maths.rad(-20.0D), Maths.rad(45.0D), Maths.rad(60.0D));
      this.animator.endKeyframe();
      this.animator.setStaticKeyframe(5);
      this.animator.resetKeyframe(5);
      this.animator.setAnimation(TusklinServant.ANIMATION_GORE_R);
      this.animator.startKeyframe(5);
      this.animator.move(this.body, 0.0F, 0.0F, 5.0F);
      this.animator.rotate(this.leg_right, Maths.rad(-30.0D), 0.0F, 0.0F);
      this.animator.rotate(this.leg_left, Maths.rad(-30.0D), 0.0F, 0.0F);
      ...
      this.animator.setStaticKeyframe(5);
      this.animator.resetKeyframe(5);
      this.animator.setAnimation(TusklinServant.ANIMATION_FLING);
      this.animator.startKeyframe(5);
      ...
      this.animator.rotate(this.arm_right, Maths.rad(-50.0D), 0.0F, Maths.rad(20.0D));
      this.animator.rotate(this.arm_left, Maths.rad(-50.0D), 0.0F, Maths.rad(-20.0D));
      this.animator.endKeyframe();
      ...
      this.animator.resetKeyframe(5);
      this.animator.setAnimation(TusklinServant.ANIMATION_BUCK);
      this.animator.startKeyframe(5);
      ...
      this.animator.rotate(this.arm_right, Maths.rad(30.0D), 0.0F, Maths.rad(-10.0D));
      this.animator.rotate(this.arm_left, Maths.rad(30.0D), 0.0F, Maths.rad(10.0D));
      this.animator.endKeyframe();
      this.animator.startKeyframe(5);
      ...
      this.animator.rotate(this.head, Maths.rad(-60.0D), 0.0F, 0.0F);
      this.animator.rotate(this.arm_right, Maths.rad(-20.0D), 0.0F, Maths.rad(-10.0D));
      this.animator.rotate(this.arm_left, Maths.rad(-20.0D), 0.0F, Maths.rad(10.0D));
      this.animator.endKeyframe();
      this.animator.resetKeyframe(5);
   }

   @Override
   public void setupAnim(TusklinServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
