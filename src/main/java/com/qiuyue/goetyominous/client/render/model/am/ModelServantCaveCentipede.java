...
public class ModelServantCaveCentipede<T extends LivingEntity> extends AdvancedEntityModel<T> {
    ...
    public ModelServantCaveCentipede(int type) {
        this.texWidth = 128;
        this.texHeight = 128;
        this.type = type;
    ...
    public void setupAnim(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float var10000 = ageInTicks - (float)entity.tickCount;
        ...
        if (this.type == 0) {
            ...
            float offset;
            double walkOffset;
            AdvancedModelBox var15;
            if (this.type == 1) {
                if (entity instanceof ServantCentipedeBody) {
                    offset = (float)((double)(((ServantCentipedeBody)entity).getBodyIndex() + 1) * Math.PI * 0.5);
                    walkOffset = (double)offset * Math.PI * 0.5;
                    ...
                    var15 = this.body;
                    var15.rotationPointY += (float)(Math.sin((double)(limbSwing * walkSpeed) - walkOffset) * (double)limbSwingAmount * (double)walkDegree - (double)(limbSwingAmount * walkDegree));
                    var15 = this.body;
                    var15.rotationPointY += (float)(Math.sin((double)ageInTicks * 0.1 - walkOffset) * 0.01);
                }
            } else if (entity instanceof ServantCentipedeBody) {
                offset = (float)((double)(((ServantCentipedeBody)entity).getBodyIndex() + 1) * Math.PI * 0.5);
                walkOffset = (double)offset * Math.PI * 0.5;
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        ...
        switch (this.type) {
            case 0 -> var10000 = ImmutableList.of(this.root, this.head, this.head2, this.fangs, this.antenna_left, this.antenna_left_r1, this.antenna_right, this.antenna_right_r1);
            case 1 -> var10000 = ImmutableList.of(this.root, this.body, this.leftLegBodyF, this.leftLeg2BodyF, this.rightLegBodyF, this.rightLegBodyF2, this.leftLegBodyB, this.leftLeg2BodyB, this.rightLegBodyB, this.rightLegBodyB2);
            case 2 -> var10000 = ImmutableList.of(this.root, this.tail, this.leftLegTailF, this.leftLeg2TailF, this.rightLegTailF, this.rightLeg2TailF, this.leftLegTailB, this.leftLegTailB2, this.rightLegTailB, this.rightLegTailB2, this.leftTail, this.leftTailEnd, new AdvancedModelBox[]{this.rightTail, this.rightTailEnd});
            default -> var10000 = ImmutableList.of(this.root);
        }
