...
public class ModelForsakenServant extends AdvancedEntityModel<ForsakenServant> {
    ...
    public void setupAnim(ForsakenServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.larm.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, -0.5F, 9.0F, true));
        this.larm.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, -1.0F, 4.0F, false));
        this.lhand.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, -1.0F, 4.0F, false));
        ...
        this.rarm.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, -0.5F, 9.0F, false));
        this.rarm.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, -1.0F, 5.0F, true));
        this.rhand.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, -1.0F, 5.0F, true));
        ...
        this.lthigh.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, -0.5F, 18.0F, false));
        this.lfoot.rotationPointZ += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, 2.0F, 8.0F, false));
        this.lfoot.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, 2.0F, 8.0F, false));
        ...
        this.rthigh.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, -0.5F, 18.0F, true));
        this.rfoot.rotationPointZ += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, 2.0F, 8.0F, true));
        this.rfoot.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, walkAmount, walkSpeed, 2.0F, 8.0F, true));
        ...
        this.root.rotationPointZ -= ACMath.walkValue(limbSwing, runAmount, runSpeed, 2.0F, 7.0F, false) + 7.0F * runAmount;
        ...
        this.larm.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, -0.5F, 8.0F, true));
        this.larm.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, -1.0F, 4.0F, false));
        this.lhand.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, -1.0F, 4.0F, false));
        ...
        this.rarm.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, -0.5F, 8.0F, true));
        this.rarm.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, -1.0F, 4.0F, false));
        this.rhand.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, -1.0F, 4.0F, false));
        ...
        this.lthigh.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, 0.5F, 10.0F, false));
        this.lfoot.rotationPointZ += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, 3.0F, 8.0F, false));
        this.lfoot.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, 3.0F, 8.0F, false));
        ...
        this.rthigh.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, 0.5F, 10.0F, false));
        this.rfoot.rotationPointZ += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, 3.0F, 8.0F, false));
        this.rfoot.rotationPointY += Math.min(0.0F, ACMath.walkValue(limbSwing, runAmount, runSpeed, 3.0F, 8.0F, false));
    ...
    private float setupAnimForAnimation(ForsakenServant entity, Animation animation, float limbSwing, float limbSwingAmount, float ageInTicks) {
        float partialTick = ageInTicks - (float) entity.tickCount;
        float rootScale = 1.0F;
        float legMoveAmount = 1.0F;
        float animationIntensity;
        if (animation == ForsakenServant.ANIMATION_SUMMON) {
        ...
        if (entity.getAnimation() == ForsakenServant.ANIMATION_SONIC_ATTACK) {
        ...
        if (entity.getAnimation() == ForsakenServant.ANIMATION_SONIC_BLAST) {
            animationIntensity = ACMath.cullAnimationTick(entity.getAnimationTick(), 1.0F, animation, partialTick, 5, 30);
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        this.animator.setAnimation(ForsakenServant.ANIMATION_PREPARE_JUMP);
        ...
        this.animator.endKeyframe();
        this.animator.setAnimation(ForsakenServant.ANIMATION_BITE);
        ...
        this.animator.setAnimation(ForsakenServant.ANIMATION_LEFT_SLASH);
        ...
        this.animator.setAnimation(ForsakenServant.ANIMATION_RIGHT_SLASH);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.root, 0.0F, (float) Math.toRadians(10.0), 0.0F);
        this.animator.rotate(this.neck, 0.0F, (float) Math.toRadians(-15.0), 0.0F);
        ...
        this.animator.setStaticKeyframe(3);
        this.animator.resetKeyframe(15);
        this.animator.setAnimation(ForsakenServant.ANIMATION_GROUND_SMASH);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.neck, (float) Math.toRadians(-20.0), 0.0F, 0.0F);
        ...
        this.animator.setAnimation(ForsakenServant.ANIMATION_SONIC_ATTACK);
        this.animator.startKeyframe(5);
        this.animator.move(this.neck, 0.0F, 0.0F, 3.0F);
        ...
        this.animator.setAnimation(ForsakenServant.ANIMATION_SONIC_BLAST);
        this.animator.startKeyframe(5);
        this.animator.move(this.neck, 0.0F, 0.0F, 3.0F);
        this.animator.rotate(this.chest, (float) Math.toRadians(10.0), 0.0F, 0.0F);
        this.animator.rotate(this.neck, (float) Math.toRadians(-20.0), 0.0F, 0.0F);
        ...
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(ForsakenServant.ANIMATION_LEFT_PICKUP);
        this.animator.startKeyframe(10);
        this.animator.move(this.lupperArm, 2.0F, 12.0F, -20.0F);
        ...
        this.animator.setStaticKeyframe(2);
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(ForsakenServant.ANIMATION_RIGHT_PICKUP);
        this.animator.startKeyframe(10);
        this.animator.move(this.rupperArm, -2.0F, 12.0F, -20.0F);
        ...
        this.animator.setStaticKeyframe(2);
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(ForsakenServant.ANIMATION_SUMMON);
