...
public class ModelCandicornServant extends AdvancedEntityModel<CandicornServant> {
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        animator.setAnimation(CandicornServant.ANIMATION_BUCK);
        ...
        animator.setAnimation(CandicornServant.ANIMATION_TAIL_FLICK_1);
        animator.startKeyframe(3);
        ...
        animator.setAnimation(CandicornServant.ANIMATION_TAIL_FLICK_2);
        animator.startKeyframe(3);
        animator.rotate(tail1, (float) Math.toRadians(25), (float) Math.toRadians(-25), 0);
        animator.rotate(tail2, (float) Math.toRadians(-10), (float) Math.toRadians(-45), 0);
        animator.endKeyframe();
        ...
        animator.endKeyframe();
        animator.resetKeyframe(3);
        animator.setAnimation(CandicornServant.ANIMATION_NIBBLE_IDLE);
        animator.startKeyframe(5);
        ...
        animator.endKeyframe();
        animator.resetKeyframe(5);
        animator.setAnimation(CandicornServant.ANIMATION_STAB);
        animator.startKeyframe(5);
        poseBucking();
    ...
    public void setupAnim(CandicornServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
