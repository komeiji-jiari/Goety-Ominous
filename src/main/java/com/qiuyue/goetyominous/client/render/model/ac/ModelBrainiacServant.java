...
@OnlyIn(Dist.CLIENT)
public class ModelBrainiacServant extends AdvancedEntityModel<BrainiacServant> {
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        this.animator.setAnimation(BrainiacServant.ANIMATION_THROW_BARREL);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.torso, 0.0F, (float)Math.toRadians(20.0F), 0.0F);
        this.animator.rotate(this.larm, (float)Math.toRadians(-270.0F), (float)Math.toRadians(-10.0F), (float)Math.toRadians(-10.0F));
        this.animator.rotate(this.handMaw, 0.0F, 0.0F, (float)Math.toRadians(20.0F));
        this.animator.rotate(this.handMaw3, 0.0F, 0.0F, (float)Math.toRadians(40.0F));
        this.animator.move(this.handMaw3, 0.0F, -4.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.setStaticKeyframe(5);
        this.animator.startKeyframe(5);
        this.animator.rotate(this.larm, (float)Math.toRadians(-80.0F), 0.0F, 0.0F);
        this.animator.rotate(this.handMaw, 0.0F, 0.0F, (float)Math.toRadians(-90.0F));
        this.animator.rotate(this.handMaw3, 0.0F, 0.0F, (float)Math.toRadians(90.0F));
        this.animator.endKeyframe();
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(BrainiacServant.ANIMATION_DRINK_BARREL);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.torso, 0.0F, (float)Math.toRadians(20.0F), 0.0F);
        this.animator.rotate(this.larm, (float)Math.toRadians(-270.0F), (float)Math.toRadians(-10.0F), (float)Math.toRadians(-10.0F));
        this.animator.rotate(this.handMaw, 0.0F, 0.0F, (float)Math.toRadians(20.0F));
        ...
        this.animator.rotate(this.head, (float)Math.toRadians(-20.0F), 0.0F, 0.0F);
        this.animator.rotate(this.larm, (float)Math.toRadians(-80.0F), (float)Math.toRadians(20.0F), 0.0F);
        this.animator.rotate(this.handMaw, 0.0F, 0.0F, (float)Math.toRadians(-90.0F));
        this.animator.rotate(this.handMaw3, 0.0F, 0.0F, (float)Math.toRadians(90.0F));
        this.animator.endKeyframe();
        ...
        this.animator.rotate(this.head, (float)Math.toRadians(-20.0F), 0.0F, 0.0F);
        this.animator.rotate(this.larm, (float)Math.toRadians(-70.0F), (float)Math.toRadians(20.0F), 0.0F);
        this.animator.rotate(this.handMaw, 0.0F, 0.0F, (float)Math.toRadians(-90.0F));
        this.animator.rotate(this.handMaw3, 0.0F, 0.0F, (float)Math.toRadians(90.0F));
        this.animator.endKeyframe();
        this.animator.startKeyframe(4);
        ...
        this.animator.setStaticKeyframe(5);
        this.animator.resetKeyframe(10);
        this.animator.setAnimation(BrainiacServant.ANIMATION_BITE);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.torso, 0.0F, (float)Math.toRadians(-10.0F), 0.0F);
        this.animator.rotate(this.chest, 0.0F, (float)Math.toRadians(-10.0F), 0.0F);
        this.animator.endKeyframe();
        ...
        this.animator.setAnimation(BrainiacServant.ANIMATION_SMASH);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.chest, (float)Math.toRadians(-30.0F), 0.0F, 0.0F);
        this.animator.rotate(this.rarm, (float)Math.toRadians(-130.0F), (float)Math.toRadians(20.0F), 0.0F);
        this.animator.rotate(this.larm, (float)Math.toRadians(-130.0F), (float)Math.toRadians(-20.0F), 0.0F);
        this.animator.rotate(this.handMaw, 0.0F, 0.0F, (float)Math.toRadians(-20.0F));
        this.animator.rotate(this.handMaw3, 0.0F, 0.0F, (float)Math.toRadians(20.0F));
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.rotate(this.chest, (float)Math.toRadians(20.0F), 0.0F, 0.0F);
        this.animator.rotate(this.rarm, (float)Math.toRadians(-20.0F), (float)Math.toRadians(-20.0F), 0.0F);
        this.animator.rotate(this.larm, (float)Math.toRadians(-20.0F), (float)Math.toRadians(20.0F), 0.0F);
        this.animator.endKeyframe();
        this.animator.resetKeyframe(5);
    }
    ...
    @Override
    public void setupAnim(BrainiacServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (tongueTarget != null && tongueLaunch > 0.0F) {
            ...
            AdvancedModelBox var10000 = this.tongue;
            var10000.rotateAngleY -= Math.toRadians(yBodyRot) + this.head.rotateAngleY + this.chest.rotateAngleY + this.torso.rotateAngleY;
            var10000 = this.tongue;
            var10000.rotateAngleY -= (float) Math.toRadians((double) (-((float) (Mth.atan2(d2, d0) * (double) (180F / (float) Math.PI))) - 90.0F));
            var10000 = this.tongue;
            var10000.rotateAngleX += (float) Math.toRadians((double) Mth.wrapDegrees((float) (Mth.atan2(d1, d3) * (double) 180.0F / (double) (float) Math.PI)));
        }
        ...
        this.progressRotationPrev(this.chest, zoomedHunch, (float)Math.toRadians(20.0F), 0.0F, 0.0F, 1.0F);
        this.progressRotationPrev(this.larm, zoomedHunch, (float)Math.toRadians(-20.0F), 0.0F, 0.0F, 1.0F);
        this.progressRotationPrev(this.rarm, zoomedHunch, (float)Math.toRadians(-20.0F), 0.0F, 0.0F, 1.0F);
        this.progressRotationPrev(this.head, zoomedHunch, (float)Math.toRadians(-20.0F), 0.0F, 0.0F, 1.0F);
        ...
        AdvancedModelBox var32 = this.tongue;
        var32.rotateAngleZ -= this.head.rotateAngleZ;
        float bodyBob = this.walkValue(limbSwing, limbSwingAmount, walkSpeed * 1.5F, 0.5F, 1.0F, true);
        var32 = this.torso;
        var32.rotationPointY += bodyBob;
        ...
        var32 = this.rarm;
        var32.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, hunchAmount, walkSpeed, -0.75F, 1.0F, false)) - bodyBob;
        var32 = this.rarm;
        var32.rotationPointZ += this.walkValue(limbSwing, hunchAmount, walkSpeed, -0.75F, -3.0F, true);
        var32 = this.larm;
        var32.rotationPointY += Math.min(0.0F, this.walkValue(limbSwing, hunchLeftAmount, walkSpeed, 0.75F, 1.0F, false)) - bodyBob;
        var32 = this.larm;
        var32.rotationPointZ += this.walkValue(limbSwing, hunchLeftAmount, walkSpeed, 0.75F, -3.0F, true);
        var32 = this.rarm;
        var32.rotateAngleZ -= this.torso.rotateAngleZ;
        var32 = this.larm;
        var32.rotateAngleZ -= this.torso.rotateAngleZ;
        float yawAmount = netHeadYaw / (180F / (float) Math.PI);
        float pitchAmount = headPitch / (180F / (float) Math.PI);
        var32 = this.head;
        var32.rotateAngleX += pitchAmount * 0.25F;
        var32 = this.head;
        var32.rotateAngleY += yawAmount * 0.5F;
    }

    @Override
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.torso, this.chest, this.lleg, this.rleg, this.rarm, this.larm, this.handMaw, this.handMaw3, this.head, this.brain, this.tongue, this.tongue2);
    }
