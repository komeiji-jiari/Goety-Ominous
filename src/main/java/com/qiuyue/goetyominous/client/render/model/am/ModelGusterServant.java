...
@OnlyIn(Dist.CLIENT)
public class ModelGusterServant extends AdvancedEntityModel<GusterServant> {
    ...
    @Override
    public void setupAnim(GusterServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
