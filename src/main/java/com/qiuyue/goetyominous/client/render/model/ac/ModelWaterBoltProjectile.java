...
@OnlyIn(Dist.CLIENT)
public class ModelWaterBoltProjectile extends AdvancedEntityModel<WaterBoltProjectile> {
    ...
    public ModelWaterBoltProjectile() {
        this.texWidth = 64;
        this.texHeight = 64;
    ...
    @Override
    public void setupAnim(WaterBoltProjectile entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
