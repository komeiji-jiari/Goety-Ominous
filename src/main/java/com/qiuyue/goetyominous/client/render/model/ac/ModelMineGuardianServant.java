...
public class ModelMineGuardianServant extends AdvancedEntityModel<MineGuardianServant> {
    ...
    public ModelMineGuardianServant() {
        this.texWidth = 64;
        this.texHeight = 64;
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.head, this.head_r1, this.eye, this.spikepart0, this.spikepart1, this.spikepart2, this.spikepart3, this.spikepart4, this.spikepart5, this.spikepart6, this.spikepart7, this.spikepart8, this.spikepart9, this.spikepart10, this.spikepart11, this.spike0, this.spike1, this.spike2, this.spike3, this.spike4, this.spike5, this.spike6, this.spike7, this.spike8, this.spike9, this.spike10, this.spike11);
    }
    ...
    @Override
    public void setupAnim(MineGuardianServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.spike0.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 0.0F, 1.0F, false) + 2.0F;
        this.spike1.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 1.0F, 1.0F, false) + 2.0F;
        this.spike2.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 2.0F, 1.0F, false) + 2.0F;
        this.spike3.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 3.0F, 1.0F, false) + 2.0F;
        this.spike4.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 4.0F, 1.0F, false) + 2.0F;
        this.spike5.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 5.0F, 1.0F, false) + 2.0F;
        this.spike6.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 6.0F, 1.0F, false) + 2.0F;
        this.spike7.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 7.0F, 1.0F, false) + 2.0F;
        this.spike8.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 8.0F, 1.0F, false) + 2.0F;
        this.spike9.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 9.0F, 1.0F, false) + 2.0F;
        this.spike10.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 10.0F, 1.0F, false) + 2.0F;
        this.spike11.rotationPointY += ACMath.walkValue(ageInTicks, 1.0F, 0.1F + explodeProgress, 11.0F, 1.0F, false) + 2.0F;
        ...
        if (look != null) {
            ...
            this.eye.rotationPointX += (float) ((d2 * 2.0F - this.head.rotateAngleZ) * (1.0F - scanProgress));
        }
        this.eye.rotationPointX += (float) (scanProgress * Math.sin(ageInTicks * 0.1F) * 3.0F);
    }
