...
@OnlyIn(Dist.CLIENT)
public class ModelDropBearServant extends AdvancedEntityModel<DropBearServant> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.setAnimation(DropBearServant.ANIMATION_BITE);
        ...
        animator.setAnimation(DropBearServant.ANIMATION_SWIPE_L);
        ...
        animator.setAnimation(DropBearServant.ANIMATION_SWIPE_R);
        animator.startKeyframe(7);
        animator.rotate(front_body, 0, Maths.rad(10F), 0);
        animator.rotate(head, 0, 0, Maths.rad(10F));
        ...
        animator.endKeyframe();
        animator.resetKeyframe(3);
        animator.setAnimation(DropBearServant.ANIMATION_JUMPUP);
    ...
    @Override
    public void setupAnim(DropBearServant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
