...
import com.qiuyue.goetyominous.common.entities.ally.am.ServantCentipedeTail;
...
public class RenderServantCentipedeTail extends MobRenderer<ServantCentipedeTail, AdvancedEntityModel<ServantCentipedeTail>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("alexsmobs:textures/entity/cave_centipede.png");

    public RenderServantCentipedeTail(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new ModelServantCaveCentipede(2), 0.5F);
    }

    protected float getFlipDegrees(ServantCentipedeTail centipede) {
        return 180.0F;
    }
    ...
    public ResourceLocation getTextureLocation(ServantCentipedeTail entity) {
        return TEXTURE;
    }
}
