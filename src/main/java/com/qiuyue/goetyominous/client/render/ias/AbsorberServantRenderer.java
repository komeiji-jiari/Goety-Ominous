package com.qiuyue.goetyominous.client.render.ias;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.math.Axis;
import com.qiuyue.goetyominous.client.render.model.ias.AbsorberServantModel;
import com.qiuyue.goetyominous.common.entities.ally.ias.AbsorberServant;
...
public class AbsorberServantRenderer extends MobRenderer<AbsorberServant, AbsorberServantModel<AbsorberServant>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("goetyominous", "textures/entity/illager/absorber1.png");
    private static final ResourceLocation DEGRADE1 = new ResourceLocation("goetyominous", "textures/entity/illager/absorber2.png");
    private static final ResourceLocation DEGRADE2 = new ResourceLocation("goetyominous", "textures/entity/illager/absorber3.png");
    private static final ResourceLocation DEGRADE3 = new ResourceLocation("goetyominous", "textures/entity/illager/absorber4.png");
