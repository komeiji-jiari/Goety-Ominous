...
public class MutantHoglinSineWaveAnimations {
    ...
    public static void mutantHoglinWalkAnimation(MutantHoglinServantModel<?> model, float tick, float speedMultiplier, float amountMultiplier) {
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLegLower, 28.0F, 250.0F, tick, 0.0F, floatMax, -125.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLeg, 20.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLeg, 5.0F, 250.0F, tick, 0.0F, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLeg, 2.0F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLegLower, -28.0F, 250.0F, tick, 0.0F, floatMax, -125.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLeg, -20.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLeg, -5.0F, 250.0F, tick, 0.0F, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLeg, -2.0F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightBackLeg, -20.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightBackLeg, -5.0F, 250.0F, tick, 0.0F, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightBackLeg, -2.0F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightBackLeg, -1.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftBackLeg, 20.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftBackLeg, 5.0F, 250.0F, tick, 0.0F, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftBackLeg, 2.0F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.head, 2.0F, 500.0F, tick, -floatMax, floatMax, 50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.head, -15.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.neck, 2.0F, 500.0F, tick, -floatMax, floatMax, 100.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.neck, 15.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.chest, 0.8F, 500.0F, tick, -floatMax, floatMax, 500.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.body, 2.0F, 500.0F, tick, -floatMax, floatMax, 100.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.body, 4.0F, 250.0F, tick, -floatMax, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.body, 1.2F, 500.0F, tick, -floatMax, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.body, -30.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
    }

    public static void mutantHoglinTrotAnimation(MutantHoglinServantModel<?> model, float tick, float speedMultiplier, float amountMultiplier) {
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLegLower, 42.0F, 250.0F, tick, 0.0F, floatMax, -125.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightFrontLegLower, -15.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLeg, 28.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLeg, 3.0F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightFrontLeg, 15.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightFrontLeg, 4.0F, amountMultiplier, SineWaveMotionTypes.POSITION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightFrontLeg, -1.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightFrontLeg, 2.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLegLower, -42.0F, 250.0F, tick, 0.0F, floatMax, -125.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftFrontLegLower, 15.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLeg, -28.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLeg, -3.0F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftFrontLeg, -15.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftFrontLeg, -4.0F, amountMultiplier, SineWaveMotionTypes.POSITION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftFrontLeg, -1.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftFrontLeg, 2.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightBackLeg, -28.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightBackLeg, -3.0F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightBackLeg, -1.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftBackLeg, 28.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftBackLeg, 3.0F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftBackLeg, -1.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.tail, 7.5F, 500.0F, tick, -floatMax, floatMax, 50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.tail, 25.0F, 100.0F, tick, -floatMax, floatMax, 50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.tail, 150.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightEar, 7.5F, 500.0F, tick, -floatMax, floatMax, 150.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_Y);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightEar, 17.411F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightEar, -58.4686F, amountMultiplier, SineWaveMotionTypes.ROTATION_Y);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightEar, -15.2017F, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        ...
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftEar, 58.4686F, amountMultiplier, SineWaveMotionTypes.ROTATION_Y);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftEar, 15.2017F, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.head, 1.5F, 500.0F, tick, -floatMax, floatMax, 50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.head, -2.5F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.head, -12.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.neck, 1.5F, 500.0F, tick, -floatMax, floatMax, 100.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.neck, 10.0F, 250.0F, tick, -floatMax, floatMax, 25.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.neck, 12.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.chest, 0.8F, 500.0F, tick, -floatMax, floatMax, 500.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.chest, 10.0F, 250.0F, tick, -floatMax, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.chest, -10.0F, 250.0F, tick, -floatMax, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.chest, 30.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.body, 1.5F, 500.0F, tick, -floatMax, floatMax, 100.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.body, 4.0F, 250.0F, tick, -floatMax, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.body, 2.0F, 500.0F, tick, -floatMax, floatMax, 60.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.body, -28.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
    }
    ...
    public static void mutantHoglinChargingAnimation(MutantHoglinServantModel<?> model, float tick, float speedMultiplier, float amountMultiplier) {
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLegLower, 62.0F, 250.0F, tick, 0.0F, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLeg, -38.0F, 250.0F, tick, -floatMax, floatMax, -100.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLeg, 9.0F, 250.0F, tick, 0.0F, floatMax, -40.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightFrontLeg, -7.0F, 250.0F, tick, -floatMax, floatMax, -150.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        ...
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightFrontLeg, -3.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLegLower, 62.0F, 250.0F, tick, 0.0F, floatMax, -150.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLeg, -38.0F, 250.0F, tick, -floatMax, floatMax, -200.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLeg, 9.0F, 250.0F, tick, 0.0F, floatMax, -140.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftFrontLeg, -7.0F, 250.0F, tick, -floatMax, floatMax, -250.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        ...
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftFrontLeg, -3.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightBackLeg, -50.0F, 250.0F, tick, -floatMax, floatMax, -200.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightBackLeg, 6.0F, 250.0F, tick, 0.0F, floatMax, -140.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.rightBackLeg, -3.5F, 250.0F, tick, -floatMax, floatMax, -250.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.rightBackLeg, -2.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftBackLeg, -50.0F, 250.0F, tick, -floatMax, floatMax, -100.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftBackLeg, 6.0F, 250.0F, tick, 0.0F, floatMax, -40.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.leftBackLeg, -3.5F, 250.0F, tick, -floatMax, floatMax, -150.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.leftBackLeg, -2.0F, amountMultiplier, SineWaveMotionTypes.POSITION_Z);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.tail, -7.5F, 500.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.tail, 145.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        ...
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.head, -6.5F, 250.0F, tick, -floatMax, floatMax, -200.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.head, -20.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.neck, -6.5F, 250.0F, tick, -floatMax, floatMax, -100.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.neck, 15.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.chest, -3.5F, 250.0F, tick, -floatMax, floatMax, -50.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.chest, 22.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.body, -4.0F, 250.0F, tick, -floatMax, floatMax, 0.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.addSineWaveMotionToModelPart(model.body, 3.5F, 250.0F, tick, -floatMax, floatMax, -140.0F, speedMultiplier, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.body, -22.0F, amountMultiplier, SineWaveMotionTypes.ROTATION_X);
        SineWaveAnimationUtils.adjustPositionOfModelPart(model.body, 4.5F, amountMultiplier, SineWaveMotionTypes.POSITION_Y);
    }
}
