...
import com.qiuyue.goetyominous.client.render.model.ZPiglinBruteModel;
...
@OnlyIn(Dist.CLIENT)
public class ZPiglinBruteRenderer extends HumanoidMobRenderer<Mob, ZPiglinModel<Mob>> {

    private static final Map<EntityType<?>, ResourceLocation> TEXTURES;

    public ZPiglinBruteRenderer(EntityRendererProvider.Context context) {
        super(context, new ZPiglinBruteModel(context.bakeLayer(ModModelLayer.ZPIGLIN_SERVANT)),
                0.5F, 1.0019531F, 1.0F, 1.0019531F);
    ...
    static {
        TEXTURES = ImmutableMap.<EntityType<?>, ResourceLocation>builder()
                .put(ModEntityTypes.STRONG_ZPIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID,
                                "textures/entity/piglin/zpiglin_brute_servant_strong.png"))
                .put(ModEntityTypes.ELITE_ZPIGLIN_BRUTE_SERVANT.get(),
                        new ResourceLocation(GoetyOminous.MOD_ID,
                                "textures/entity/piglin/zpiglin_brute_servant_elite.png"))
                .build();
    }
}
