...
import com.qiuyue.goetyominous.client.render.model.ua.FlareServantModel;
...
@OnlyIn(Dist.CLIENT)
public class FlareServantEyesRenderLayer<T extends FlareServant, M extends FlareServantModel<T>> extends RenderLayer<T, M> {
    ...
    public FlareServantEyesRenderLayer(RenderLayerParent<T, M> renderer) {
        super(renderer);
    }
