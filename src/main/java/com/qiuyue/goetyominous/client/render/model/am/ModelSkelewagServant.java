...
@OnlyIn(Dist.CLIENT)
public class ModelSkelewagServant<T extends SkelewagServant> extends AdvancedEntityModel<T> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        animator.setAnimation(SkelewagServant.ANIMATION_STAB);
        ...
        animator.setAnimation(SkelewagServant.ANIMATION_SLASH);
