...
@OnlyIn(Dist.CLIENT)
public class ModelGammaroachServant extends AdvancedEntityModel<GammaroachServant> {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.body, this.head, this.lantennae, this.rantennae, this.carapace, this.mtail, this.rtail, this.ltail, this.bodyThing2, this.bodyThing, this.antenna1Thing, this.atenna2Thing, this.cube_r5, this.rleg, this.rleg2, this.rleg3, this.lleg, this.lleg2, this.lleg3);
    }

    public void animate(IAnimatedEntity entity) {
        this.animator.update(entity);
        this.animator.setAnimation(GammaroachServant.ANIMATION_SPRAY);
        this.animator.startKeyframe(10);
        this.animator.rotate(this.body, (float) Math.toRadians(30.0F), 0.0F, 0.0F);
        this.animator.rotate(this.carapace, (float) Math.toRadians(-30.0F), 0.0F, 0.0F);
        this.animator.rotate(this.lleg, (float) Math.toRadians(-10.0F), (float) Math.toRadians(-30.0F), 0.0F);
        this.animator.rotate(this.rleg, (float) Math.toRadians(-10.0F), (float) Math.toRadians(30.0F), 0.0F);
        this.animator.rotate(this.lleg2, (float) Math.toRadians(-30.0F), 0.0F, 0.0F);
        this.animator.rotate(this.rleg2, (float) Math.toRadians(-30.0F), 0.0F, 0.0F);
        this.animator.rotate(this.lleg3, (float) Math.toRadians(-10.0F), (float) Math.toRadians(40.0F), (float) Math.toRadians(-20.0F));
        this.animator.rotate(this.rleg3, (float) Math.toRadians(-10.0F), (float) Math.toRadians(-40.0F), (float) Math.toRadians(20.0F));
        ...
        this.animator.setAnimation(GammaroachServant.ANIMATION_RAM);
        this.animator.startKeyframe(5);
        this.animator.move(this.body, 0.0F, 0.0F, 6.0F);
        this.animator.rotate(this.lleg, 0.0F, (float) Math.toRadians(30.0F), 0.0F);
        this.animator.rotate(this.rleg, 0.0F, (float) Math.toRadians(-30.0F), 0.0F);
        this.animator.rotate(this.lleg2, 0.0F, (float) Math.toRadians(40.0F), 0.0F);
        this.animator.rotate(this.rleg2, 0.0F, (float) Math.toRadians(-40.0F), 0.0F);
        this.animator.rotate(this.lleg3, 0.0F, (float) Math.toRadians(50.0F), 0.0F);
        this.animator.rotate(this.rleg3, 0.0F, (float) Math.toRadians(-50.0F), 0.0F);
        this.animator.endKeyframe();
        this.animator.setStaticKeyframe(2);
        this.animator.startKeyframe(3);
        this.animator.move(this.body, 0.0F, 0.0F, -9.0F);
        this.animator.move(this.carapace, 0.0F, 1.0F, -2.0F);
        this.animator.rotate(this.carapace, (float) Math.toRadians(20.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, (float) Math.toRadians(20.0F), 0.0F, 0.0F);
        this.animator.rotate(this.lleg, 0.0F, (float) Math.toRadians(-30.0F), 0.0F);
        this.animator.rotate(this.rleg, 0.0F, (float) Math.toRadians(30.0F), 0.0F);
        this.animator.rotate(this.lleg2, 0.0F, (float) Math.toRadians(-40.0F), 0.0F);
        this.animator.rotate(this.rleg2, 0.0F, (float) Math.toRadians(40.0F), 0.0F);
        this.animator.rotate(this.lleg3, 0.0F, (float) Math.toRadians(-20.0F), 0.0F);
        this.animator.rotate(this.rleg3, 0.0F, (float) Math.toRadians(20.0F), 0.0F);
        this.animator.rotate(this.rantennae, (float) Math.toRadians(-80.0F), 0.0F, 0.0F);
        this.animator.rotate(this.lantennae, (float) Math.toRadians(-80.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.setStaticKeyframe(5);
        this.animator.resetKeyframe(10);
    }

    private void setupAnimForAnimation(GammaroachServant entity, Animation animation, float limbSwing, float limbSwingAmount, float ageInTicks) {
        float partialTick = ageInTicks - (float) entity.tickCount;
        if (animation == GammaroachServant.ANIMATION_SPRAY) {
    ...
    @Override
    public void setupAnim(GammaroachServant entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetToDefaultPose();
        this.animate(entity);
        float walkSpeed = 1.0F;
        float walkDegree = 0.9F;
        float partialTicks = ageInTicks - (float) entity.tickCount;
        float deathAmount = ((float) entity.deathTime + partialTicks) / 20.0F;
        this.progressRotationPrev(this.rantennae, limbSwingAmount, (float) Math.toRadians(-80.0F), 0.0F, (float) Math.toRadians(20.0F), 1.0F);
        this.progressRotationPrev(this.lantennae, limbSwingAmount, (float) Math.toRadians(-80.0F), 0.0F, (float) Math.toRadians(-20.0F), 1.0F);
        if ((double) entity.deathTime > (double) 0.0F) {
