...
public class GoetyAwakenCompat {
    ...
    public static boolean isObsidianMonolithServant(LivingEntity entity) {
        ...
        try {
            ...
            System.err.println("[GoetyOminous] GoetyAwaken ObsidianMonolithServant class not found: " + e.getMessage());
            return false;
        }
    }
    ...
    public static boolean isGoetyAwakenHeresiarchServant(LivingEntity entity) {
        ...
        try {
            ...
            System.err.println("[GoetyOminous] Failed to check GoetyAwaken HeresiarchServant: " + e.getMessage());
            return false;
        }
    }
}
