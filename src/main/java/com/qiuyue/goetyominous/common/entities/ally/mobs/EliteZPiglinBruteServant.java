...
public class EliteZPiglinBruteServant extends ZPiglinBruteServant {

    public EliteZPiglinBruteServant(EntityType<? extends ZPiglinBruteServant> type, Level level) {
        super(type, level);
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (this.getTrueOwner() != null && player.getUUID().equals(this.getTrueOwner().getUUID())
            ...
            if (heldItem instanceof SwordItem || heldItem instanceof AxeItem
                    || heldItem instanceof com.qiuyue.goetyominous.common.items.BoneCudgelItem) {
