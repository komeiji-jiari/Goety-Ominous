...
public class StratlingAttackGoal extends Goal {
    ...
    public StratlingAttackGoal(IAnimatedMonsterServant entity, int getattackstate, int attackstate,
        ...
        this.setFlags(EnumSet.of(Goal.Flag.LOOK, Goal.Flag.JUMP));
    }
