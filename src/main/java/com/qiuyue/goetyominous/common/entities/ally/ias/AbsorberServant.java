package com.qiuyue.goetyominous.common.entities.ally.ias;
...
import com.qiuyue.goetyominous.compat.mod.GoetySpillageCompat;
...
public class AbsorberServant extends AbstractIllagerServant implements ICanBeAnimated {
    ...
    private void tryConvertToUndead() {
        ...
        try {
            ...
            System.err.println("[GoetyOminous] AbsorberServant undead conversion failed: " + e.getMessage());
        }
    }
