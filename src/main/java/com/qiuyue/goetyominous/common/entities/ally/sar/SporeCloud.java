...
public class SporeCloud extends SpellThrowableProjectile {
    ...
    public SporeCloud(Level world, LivingEntity thrower) {
        super(com.qiuyue.goetyominous.common.init.sar.SarEntityRegistry.SPORE_CLOUD.get(), thrower, world);
    }

    public SporeCloud(Level world, double x, double y, double z) {
        super(com.qiuyue.goetyominous.common.init.sar.SarEntityRegistry.SPORE_CLOUD.get(), x, y, z, world);
    }
