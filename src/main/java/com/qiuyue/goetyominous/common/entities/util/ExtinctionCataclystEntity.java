...
public class ExtinctionCataclystEntity extends ItemEntity {
    ...
    public ExtinctionCataclystEntity(EntityType<? extends ItemEntity> entityType, Level level) {
        super(entityType, level);
    }

    public ExtinctionCataclystEntity(Level level, double x, double y, double z, ItemStack stack) {
        this(AcEntityRegistry.EXTINCTION_CATACLYST.get(), level);
        this.setPos(x, y, z);
        this.setItem(stack);
