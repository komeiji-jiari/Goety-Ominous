...
public class LuxtructosaurusServantPartEntity extends PartEntity<LuxtructosaurusServant> {
    private final Entity connectedTo;
    private EntityDimensions size;
    public float scale = 1.0F;

    public LuxtructosaurusServantPartEntity(LuxtructosaurusServant parent, Entity connectedTo, float sizeXZ, float sizeY) {
        super(parent);
