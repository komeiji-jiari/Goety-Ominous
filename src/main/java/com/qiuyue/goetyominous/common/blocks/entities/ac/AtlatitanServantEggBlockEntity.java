...
public class AtlatitanServantEggBlockEntity extends BlockEntity implements IOwnedBlock {

    private UUID ownerUUID;
    private int ownerClientId = -1;

    public AtlatitanServantEggBlockEntity(BlockPos pos, BlockState state) {
        super(AcBlockEntityRegistry.ATLATITAN_SERVANT_EGG.get(), pos, state);
    }
