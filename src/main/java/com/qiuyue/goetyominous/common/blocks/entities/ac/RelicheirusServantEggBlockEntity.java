...
public class RelicheirusServantEggBlockEntity extends BlockEntity implements IOwnedBlock {

    private UUID ownerUUID;
    private int ownerClientId = -1;

    public RelicheirusServantEggBlockEntity(BlockPos pos, BlockState state) {
        super(AcBlockEntityRegistry.RELICHEIRUS_SERVANT_EGG.get(), pos, state);
    }
