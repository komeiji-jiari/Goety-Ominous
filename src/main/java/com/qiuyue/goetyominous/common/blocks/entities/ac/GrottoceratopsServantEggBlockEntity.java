...
public class GrottoceratopsServantEggBlockEntity extends BlockEntity implements IOwnedBlock {

    private UUID ownerUUID;
    private int ownerClientId = -1;

    public GrottoceratopsServantEggBlockEntity(BlockPos pos, BlockState state) {
        super(AcBlockEntityRegistry.GROTTOCERATOPS_SERVANT_EGG.get(), pos, state);
    }
