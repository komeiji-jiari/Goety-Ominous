...
public class VallumraptorServantEggBlockEntity extends BlockEntity implements IOwnedBlock {

    private UUID ownerUUID;
    private int ownerClientId = -1;

    public VallumraptorServantEggBlockEntity(BlockPos pos, BlockState state) {
        super(AcBlockEntityRegistry.VALLUMRAPTOR_SERVANT_EGG.get(), pos, state);
    }
