...
public class TremorsaurusServantEggBlockEntity extends BlockEntity implements IOwnedBlock {

    private UUID ownerUUID;
    private int ownerClientId = -1;

    public TremorsaurusServantEggBlockEntity(BlockPos pos, BlockState state) {
        super(AcBlockEntityRegistry.TREMORSAURUS_SERVANT_EGG.get(), pos, state);
    }
