...
import com.qiuyue.goetyominous.common.entities.projectile.EntityEmuServantEgg;
...
public class EmuServantEggItem extends Item {

    public EmuServantEggItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            EntityEmuServantEgg egg = new EntityEmuServantEgg(level, player);
