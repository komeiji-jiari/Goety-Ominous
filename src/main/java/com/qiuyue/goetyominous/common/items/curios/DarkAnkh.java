...
public class DarkAnkh extends Item implements ICurioItem, IFocus {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("info.goetyominous.dark_ankh").withStyle(ChatFormatting.DARK_PURPLE));
        ...
        if (duration > 0) {
            ...
            tooltip.add(Component.translatable("info.goetyominous.dark_ankh.duration", effectiveDuration, chancePercent).withStyle(ChatFormatting.BLUE));
        }

        if (velocity > 0 || potency > 0) {
            tooltip.add(Component.translatable("info.goetyominous.dark_ankh.spell_buff").withStyle(ChatFormatting.DARK_PURPLE));
        }
        ...
        if (velocity > 0) {
            ...
            tooltip.add(Component.translatable("info.goetyominous.dark_ankh.velocity", velocity, speedAmplifier + 1, speedDurationSeconds).withStyle(ChatFormatting.BLUE));
        }
        ...
        if (potency > 0) {
            ...
            tooltip.add(Component.translatable("info.goetyominous.dark_ankh.potency", effectivePotency, buffAmplifier + 1, buffDurationSeconds).withStyle(ChatFormatting.BLUE));
        }
    }
    ...
    private static boolean hasDarkAnkh(Player player) {
        return top.theillusivec4.curios.api.CuriosApi.getCuriosInventory(player)
                .map(inv -> inv.findFirstCurio(com.qiuyue.goetyominous.common.items.ModItems.DARK_ANKH.get()))
