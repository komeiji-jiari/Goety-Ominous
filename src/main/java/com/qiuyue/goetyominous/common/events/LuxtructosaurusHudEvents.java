...
public class LuxtructosaurusHudEvents {
    ...
    private static final int DINO_V_OFFSET = 126;
    private static final int DINO_BAR_HEIGHT = 32;
    private static final int DINO_Y_EXTRA = 3;
    ...
    public static void onPreRenderGuiOverlay(RenderGuiOverlayEvent.Pre event) {
        ...
        if (player != null && player.getVehicle() instanceof LuxtructosaurusServant) {
    ...
    public static void onPostRenderGuiOverlay(RenderGuiOverlayEvent.Post event) {
        ...
        if (player == null || !(player.getVehicle() instanceof LuxtructosaurusServant servant)) {
            return;
        }
        ...
        guiGraphics.blit(DINOSAUR_HUD_OVERLAYS, x, y, 50, DINO_U_OFFSET,
                DINO_V_OFFSET + DINO_BAR_HEIGHT, 43, DINO_BAR_HEIGHT, 128, 512);
        guiGraphics.blit(DINOSAUR_HUD_OVERLAYS, x, y, 50, DINO_U_OFFSET,
                DINO_V_OFFSET, 43, (int) Math.floor(DINO_BAR_HEIGHT * invProgress), 128, 512);
