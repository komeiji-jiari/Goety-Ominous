...
public class RunePrisonSpell extends Spell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.goetyominous.config.SpellConfig.RunePrisonSoulCost.get();
    }
    ...
    public int defaultSpellCooldown() {
        return com.qiuyue.goetyominous.config.SpellConfig.RunePrisonCooldown.get();
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (staff.is(ModItems.OMINOUS_STAFF.get())) {
            float damage = com.qiuyue.goetyominous.config.SpellConfig.RunePrisonDamage.get().floatValue() + potency;
