...
public class BroodSpell extends SummonSpell {
    ...
    public int defaultSoulCost() {
        return com.qiuyue.goetyominous.config.SpellConfig.BroodSoulCost.get();
    }
    ...
    public int SummonDownDuration() {
        return com.qiuyue.goetyominous.config.SpellConfig.BroodSummonDown.get();
    }
    ...
    public int defaultSpellCooldown() {
        return com.qiuyue.goetyominous.config.SpellConfig.BroodCoolDown.get();
    }
