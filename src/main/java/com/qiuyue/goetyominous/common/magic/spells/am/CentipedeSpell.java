...
public class CentipedeSpell extends SummonSpell {

    public int defaultSoulCost() {
        return (Integer) SpellConfig.CentipedeCost.get();
    }

    public int defaultCastDuration() {
        return (Integer) SpellConfig.CentipedeDuration.get();
    }

    public int SummonDownDuration() {
        return (Integer) SpellConfig.CentipedeSummonDown.get();
    }
    ...
    public int defaultSpellCooldown() {
        return (Integer) SpellConfig.CentipedeCoolDown.get();
    }
    ...
    public Predicate<LivingEntity> summonPredicate() {
        return (livingEntity) -> livingEntity instanceof ServantCentipedeHead;
    }

    public int summonLimit() {
        return (Integer) MobsConfig.CentipedeLimit.get();
    }

    @Override
    public boolean rightStaff(ItemStack staff) {
        return super.rightStaff(staff) || this.typeStaff(staff, SpellType.GEOMANCY);
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        if (!this.isShifting(caster)) {
            ...
            for (int i1 = 0; i1 < i; ++i1) {
                ServantCentipedeHead summonedentity = new ServantCentipedeHead(AmEntityRegistry.SERVANT_CENTIPEDE_HEAD.get(), worldIn);
