...
public class DredenSpell extends SummonSpell {
    public DredenSpell() {
    }

    public int defaultSoulCost() {
        return SpellConfig.DredenSoulCost.get();
    }

    public int defaultCastDuration() {
        return SpellConfig.DredenCastDuration.get();
    }
    ...
    public Predicate<LivingEntity> summonPredicate() {
        return livingEntity -> livingEntity instanceof DredenServant;
    }

    public int summonLimit() {
        return (Integer) com.Polarice3.Goety.config.SpellConfig.WraithLimit.get();
    }
    ...
    public void SpellResult(ServerLevel worldIn, LivingEntity caster, ItemStack staff, SpellStat spellStat) {
        ...
        for (int i1 = 0; i1 < i; ++i1) {
            DredenServant summonedentity = new DredenServant(
                    ModEntityTypes.DREDEN_SERVANT.get(), worldIn);
