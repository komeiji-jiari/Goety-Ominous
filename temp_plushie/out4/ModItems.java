...
import com.Polarice3.Goety.common.items.curios.SeaAmuletItem;
import com.Polarice3.Goety.common.items.curios.SingleFoiledStackItem;
...
import com.Polarice3.Goety.common.items.equipment.BoneheadHammerItem;
import com.Polarice3.Goety.common.items.equipment.DarkMetalScythe;
...
import com.Polarice3.Goety.common.items.equipment.GraverobberShovelItem;
...
import com.Polarice3.Goety.common.items.equipment.ModToolItems;
...
import com.Polarice3.Goety.common.items.equipment.StormlanderItem;
...
import com.Polarice3.Goety.common.items.magic.GoodwillGrimoire;
...
import com.Polarice3.Goety.common.magic.spells.abyss.GulfTentacleSpell;
...
import com.Polarice3.Goety.common.magic.spells.geomancy.MinistrousSpell;
...
import com.Polarice3.Goety.common.magic.spells.geomancy.SmackStoneSpell;
...
import com.Polarice3.Goety.common.magic.spells.nether.HoggingSpell;
...
import com.Polarice3.Goety.common.magic.spells.storm.SurgingSpell;
...
import com.Polarice3.Goety.common.magic.spells.void_spells.VoidBombSpell;
...
import com.Polarice3.Goety.common.magic.spells.wild.CarrionSpell;
...
import com.Polarice3.Goety.init.ModTags.BannerPatterns;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> UNHOLY_FABRIC = ITEMS.register("unholy_fabric", () -> new Item((new Item.Properties()).m_41486_()));
    ...
    public static final RegistryObject<Item> VOID_ECHO = ITEMS.register("void_echo", () -> new Item((new Item.Properties()).m_41486_()));
    ...
    public static final RegistryObject<Item> OMINOUS_ORB = ITEMS.register("ominous_orb", () -> new RepeatCraftItem((new Item.Properties()).m_41487_(1)));
    ...
    public static final RegistryObject<Item> NETHERITE_TRAMPLER_ARMOR = ITEMS.register("netherite_trampler_armor", () -> new TramplerArmorItem(15, "netherite", (new Item.Properties()).m_41487_(1).m_41486_()));
    ...
    public static final RegistryObject<Item> NETHERITE_RAVAGER_ARMOR = ITEMS.register("netherite_ravager_armor", () -> new RavagerArmorItem(20, "netherite", (new Item.Properties()).m_41487_(1).m_41486_()));
    public static final RegistryObject<Item> WITHERED_MANUSCRIPT = ITEMS.register("withered_manuscript", () -> new Item((new Item.Properties()).m_41486_()));
    public static final RegistryObject<Item> SHROUDED_BLUEPRINT = ITEMS.register("shrouded_blueprint", () -> new Item((new Item.Properties()).m_41486_()));
    ...
    public static final RegistryObject<Item> FEET_OF_FROG = ITEMS.register("feet_of_frog", () -> new Item((new Item.Properties()).m_41489_(Foods.f_38819_)));
    public static final RegistryObject<Item> COOKED_FEET_OF_FROG = ITEMS.register("cooked_feet_of_frog", () -> new Item((new Item.Properties()).m_41489_(Foods.f_38822_)));
    public static final RegistryObject<Item> VOID_BOTTLE = ITEMS.register("void_bottle", VoidBottleItem::new);
    public static final RegistryObject<Item> VOID_BUCKET = ITEMS.register("void_bucket", () -> new BucketItem(ModFluids.VOID_FLUID_SOURCE, (new Item.Properties()).m_41495_(Items.f_42446_).m_41487_(1)));
    public static final RegistryObject<Item> END_MUD_BOTTLE = ITEMS.register("end_mud_bottle", () -> new Item((new Item.Properties()).m_41495_(Items.f_42590_)));
    public static final RegistryObject<Item> END_MUD_BUCKET = ITEMS.register("end_mud_bucket", () -> new BucketItem(ModFluids.END_MUD_FLUID_SOURCE, (new Item.Properties()).m_41495_(Items.f_42446_).m_41487_(1)));
    ...
    public static final RegistryObject<Item> HENBANE_FLOWER = ITEMS.register("henbane_flower", () -> new Item((new Item.Properties()).m_41489_(ModFoods.HENBANE)));
    public static final RegistryObject<Item> NIGHTSHADE_BLOSSOM = ITEMS.register("nightshade_blossom", () -> new Item((new Item.Properties()).m_41489_(ModFoods.NIGHTSHADE)));
    ...
    public static final RegistryObject<Item> RESILIENCE_LOTION = ITEMS.register("resilience_lotion", () -> new UnguentItem(new MobEffectInstance[]{new MobEffectInstance(MobEffects.f_19606_, MathHelper.minutesToTicks(3))}));
    public static final RegistryObject<Item> AGING_CREAM = ITEMS.register("aging_cream", () -> new UnguentItem(new MobEffectInstance[]{new MobEffectInstance((MobEffect)GoetyEffects.WANE.get(), MathHelper.minutesToTicks(3)), new MobEffectInstance((MobEffect)GoetyEffects.SAPPED.get(), MathHelper.minutesToTicks(3))}));
    ...
    public static final RegistryObject<Item> HAUNTED_BOAT = ITEMS.register("haunted_boat", () -> new ModBoatItem(false, Type.HAUNTED, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> HAUNTED_CHEST_BOAT = ITEMS.register("haunted_chest_boat", () -> new ModBoatItem(true, Type.HAUNTED, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> ROTTEN_BOAT = ITEMS.register("rotten_boat", () -> new ModBoatItem(false, Type.ROTTEN, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> ROTTEN_CHEST_BOAT = ITEMS.register("rotten_chest_boat", () -> new ModBoatItem(true, Type.ROTTEN, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> WINDSWEPT_BOAT = ITEMS.register("windswept_boat", () -> new ModBoatItem(false, Type.WINDSWEPT, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> WINDSWEPT_CHEST_BOAT = ITEMS.register("windswept_chest_boat", () -> new ModBoatItem(true, Type.WINDSWEPT, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> PINE_BOAT = ITEMS.register("pine_boat", () -> new ModBoatItem(false, Type.PINE, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> PINE_CHEST_BOAT = ITEMS.register("pine_chest_boat", () -> new ModBoatItem(true, Type.PINE, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> CHORUS_BOAT = ITEMS.register("chorus_boat", () -> new ModBoatItem(false, Type.CHORUS, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> CHORUS_CHEST_BOAT = ITEMS.register("chorus_chest_boat", () -> new ModBoatItem(true, Type.CHORUS, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> CORRUPT_CHORUS_BOAT = ITEMS.register("corrupt_chorus_boat", () -> new ModBoatItem(false, Type.CORRUPT_CHORUS, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> CORRUPT_CHORUS_CHEST_BOAT = ITEMS.register("corrupt_chorus_chest_boat", () -> new ModBoatItem(true, Type.CORRUPT_CHORUS, (new Item.Properties()).m_41487_(1)));
    ...
    public static final RegistryObject<Item> CROSS_BANNER_PATTERN = ITEMS.register("cross_banner_pattern", () -> new BannerPatternItem(BannerPatterns.PATTERN_ITEM_CROSS, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> GALE_BANNER_PATTERN = ITEMS.register("gale_banner_pattern", () -> new BannerPatternItem(BannerPatterns.PATTERN_ITEM_GALE, (new Item.Properties()).m_41487_(1)));
    public static final RegistryObject<Item> MOON_BANNER_PATTERN = ITEMS.register("moon_banner_pattern", () -> new BannerPatternItem(BannerPatterns.PATTERN_ITEM_MOON, (new Item.Properties()).m_41487_(1)));
    ...
    public static final RegistryObject<SingleStackItem> NETHER_CROWN = ITEMS.register("nether_crown", () -> new MagicCrownItem((new Item.Properties()).m_41486_().m_41487_(1), SpellType.NETHER));
    ...
    public static final RegistryObject<Item> CURSED_KNIGHT_HELMET = ITEMS.register("cursed_knight_helmet", () -> new CursedKnightArmor(net.minecraft.world.item.ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> CURSED_KNIGHT_CHESTPLATE = ITEMS.register("cursed_knight_chestplate", () -> new CursedKnightArmor(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> CURSED_KNIGHT_LEGGINGS = ITEMS.register("cursed_knight_leggings", () -> new CursedKnightArmor(net.minecraft.world.item.ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> CURSED_KNIGHT_BOOTS = ITEMS.register("cursed_knight_boots", () -> new CursedKnightArmor(net.minecraft.world.item.ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> CURSED_PALADIN_HELMET = ITEMS.register("cursed_paladin_helmet", () -> new CursedPaladinArmor(net.minecraft.world.item.ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> CURSED_PALADIN_CHESTPLATE = ITEMS.register("cursed_paladin_chestplate", () -> new CursedPaladinArmor(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> CURSED_PALADIN_LEGGINGS = ITEMS.register("cursed_paladin_leggings", () -> new CursedPaladinArmor(net.minecraft.world.item.ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> CURSED_PALADIN_BOOTS = ITEMS.register("cursed_paladin_boots", () -> new CursedPaladinArmor(net.minecraft.world.item.ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> BLACK_IRON_HELMET = ITEMS.register("black_iron_helmet", () -> new BlackIronArmor(net.minecraft.world.item.ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> BLACK_IRON_CHESTPLATE = ITEMS.register("black_iron_chestplate", () -> new BlackIronArmor(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> BLACK_IRON_LEGGINGS = ITEMS.register("black_iron_leggings", () -> new BlackIronArmor(net.minecraft.world.item.ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> BLACK_IRON_BOOTS = ITEMS.register("black_iron_boots", () -> new BlackIronArmor(net.minecraft.world.item.ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> DARK_HELMET = ITEMS.register("dark_helmet", () -> new DarkArmor(net.minecraft.world.item.ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> DARK_CHESTPLATE = ITEMS.register("dark_chestplate", () -> new DarkArmor(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> DARK_LEGGINGS = ITEMS.register("dark_leggings", () -> new DarkArmor(net.minecraft.world.item.ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> DARK_BOOTS = ITEMS.register("dark_boots", () -> new DarkArmor(net.minecraft.world.item.ArmorItem.Type.BOOTS));
    ...
    public static final RegistryObject<Item> NETHER_STAFF = ITEMS.register("nether_staff", () -> new DarkStaff(DarkWand.wandProperties().m_41486_(), ItemConfig.NetherStaffDamage.get(), SpellType.NETHER));
    ...
    public static final RegistryObject<Item> REINFORCED_ICE_AXE = ITEMS.register("reinforced_ice_axe", () -> new IceAxeItem(Tiers.IRON, (new Item.Properties()).m_41503_(600)));
    ...
    public static final RegistryObject<Item> FELL_BLADE = ITEMS.register("fell_blade", () -> new SwordItem(ModTiers.SPECIAL, 3, -2.4F, (new Item.Properties()).m_41503_(256)));
    ...
    public static final RegistryObject<Item> MUSIC_DISC_ENDERMAN = ITEMS.register("music_disc_enderman", () -> new RecordItem(14, ModSounds.MUSIC_DISC_ENDERMAN, (new Item.Properties()).m_41487_(1).m_41497_(Rarity.RARE), 2240));
    public static final RegistryObject<Item> MUSIC_DISC_RM = ITEMS.register("music_disc_rm", () -> new RecordItem(14, ModSounds.MUSIC_DISC_RM, (new Item.Properties()).m_41487_(1).m_41497_(Rarity.RARE), 3200));
    public static final RegistryObject<Item> MUSIC_DISC_VIZIER = ITEMS.register("music_disc_vizier", () -> new RecordItem(14, ModSounds.MUSIC_DISC_VIZIER, (new Item.Properties()).m_41487_(1).m_41497_(Rarity.RARE), 1860));
    public static final RegistryObject<Item> MUSIC_DISC_KEEPER = ITEMS.register("music_disc_keeper", () -> new RecordItem(14, ModSounds.MUSIC_DISC_KEEPER, (new Item.Properties()).m_41487_(1).m_41497_(Rarity.RARE), 4640));
    public static final RegistryObject<Item> MUSIC_DISC_APOSTLE = ITEMS.register("music_disc_apostle", () -> new RecordItem(15, ModSounds.MUSIC_DISC_APOSTLE, (new Item.Properties()).m_41487_(1).m_41497_(Rarity.RARE), 3440));
    public static final RegistryObject<Item> PEDESTAL_DUMMY = ITEMS.register("pedestal_dummy", () -> new Item(new Item.Properties()));
    public static final RegistryObject<DummyItem> JEI_DUMMY_NONE = ITEMS.register("jei_dummy/none", () -> new DummyItem(new Item.Properties()));
    public static final RegistryObject<DummyItem> JEI_DUMMY_REQUIRE_SACRIFICE = ITEMS.register("jei_dummy/sacrifice", () -> new DummyItem(new Item.Properties()));
    public static final RegistryObject<Item> BONE_SHARD = ITEMS.register("bone_shard", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> COOKING_LADLE = ITEMS.register("cooking_ladle", () -> new Item(new Item.Properties()));
    ...
    public static boolean shouldSkipCreativeModTab(Item item) {
        return item == JEI_DUMMY_NONE.get() || item == JEI_DUMMY_REQUIRE_SACRIFICE.get() || item == PEDESTAL_DUMMY.get() || item == BONE_SHARD.get() || item == COOKING_LADLE.get() || item instanceof TotemOfSouls || item instanceof BrewItem;
    }
}
