...
public class GraveGolemSkullItem extends StandingAndWallBlockItem {
    public GraveGolemSkullItem(Item.Properties p_43250_) {
        super((Block)ModBlocks.GRAVE_GOLEM_SKULL_BLOCK.get(), (Block)ModBlocks.WALL_GRAVE_GOLEM_SKULL_BLOCK.get(), p_43250_, Direction.DOWN);
    }
