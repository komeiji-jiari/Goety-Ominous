...
public class RedstoneGolemSkullItem extends StandingAndWallBlockItem {
    public RedstoneGolemSkullItem(Item.Properties p_43250_) {
        super((Block)ModBlocks.REDSTONE_GOLEM_SKULL_BLOCK.get(), (Block)ModBlocks.WALL_REDSTONE_GOLEM_SKULL_BLOCK.get(), p_43250_, Direction.DOWN);
    }
